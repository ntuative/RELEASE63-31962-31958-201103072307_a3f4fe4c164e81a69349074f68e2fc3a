package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1267:Number = 25;
      
      private static const const_1264:Number = 90;
      
      private static const const_939:int = 50;
      
      private static const const_1304:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1345:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_594 = new Object();
         this.var_593 = new Array();
         this.var_592 = new Array();
         super();
         this._windowManager = param1;
         this.var_1345 = param2;
         this.var_717 = new Timer(const_1267);
         this.var_717.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < this.var_345.length)
         {
            this.repositionWindow(this.var_345[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_939 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_939 || param1.desktop.height - param1.y < const_1304;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1345.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_345.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1345.getIconLoc(param1.iconId);
      ...
      {
         return this.var_593[this.var_592.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_592[this.var_593.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_592.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_592.splice(_loc3_,1);
            this.var_593.splice(_loc3_,1);
         }
         this.var_593.push(param1.name);
         this.var_592.push(param2);
         param1.addEventListener(WindowEvent.const_354,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_244,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_594[_loc3_] == null)
            {
               this.var_594[_loc3_] = new Array();
            }
            if(this.var_594[_loc3_].indexOf(param1) < 0)
            {
               this.var_594[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_345.indexOf(param1) > -1)
         {
            if(const_203)
            {
            ...
            else
            {
               ...
               this.var_345.splice(this.var_345.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_593.length)
         {
            if(this.var_593[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_592[_loc2_];
               if(this.var_594[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_594[_loc3_].length)
                  {
                     this.repositionWindow(this.var_594[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_345.length)
         {
            _loc2_ = this._itemList[this.var_345[_loc7_]];
            if(_loc2_.active)
            {
