package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private var var_567:IWindowContainer;
      
      private const const_1689:int = 10;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_1689;
         _loc3_.y = this.const_1689;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_567)
         {
            this.var_567 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
