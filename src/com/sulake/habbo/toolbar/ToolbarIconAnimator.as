package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1481 = param1.loop;
         if(param1.background != null)
         {
            this.var_790 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_976.push(_loc11_);
                  this.var_974.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_976.push(new XML());
               this.var_974.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_974[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1481 == true || this.var_975 == 0)
         {
            if(this.var_976.length > 0)
            {
               ++this._frame;
      ...
      {
         return this.var_976.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1481 == false && this.var_975 == 1 && this.var_1577 != this._state;
      }
      ...
      private function updateAssetInWindow(param1:IBitmapWrapperWindow) : void
      {
         ...
         {
            _loc2_ = this.var_974[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_790.width),Math.max(param2.height,this.var_790.height),true,0);
            _loc4_ = _loc3_.height - this.var_790.rect.height;
            _loc3_.copyPixels(this.var_790,this.var_790.rect,new Point(0,_loc4_),null,null,true);
