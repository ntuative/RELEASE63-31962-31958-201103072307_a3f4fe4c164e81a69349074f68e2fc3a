package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_470:String = "LEFT";
      
      private var var_151:Number = 50;
      
      private var var_1077:Boolean = true;
      
      private var var_1076:Number = 1;
      
      private var var_1314:Number = 0;
      
      private var var_1639:Number = 15;
      
      private var var_1638:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2789 = new Array();
         this.var_242 = new Array();
         this.var_580 = new Array();
         super();
         this._events = param3;
         ...
         this.var_151 = this._window.width;
         this.var_208 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_63,HabboWindowStyle.const_1188,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1077 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1077)
         {
         ...
         this.var_1076 = _loc6_.toolbar.@margin_top;
         this.var_1314 = _loc6_.toolbar.@margin_bottom;
         this.var_1639 = _loc6_.toolbar.@min_group_margin;
         this.var_1638 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_293 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_242,param1,param2,this._window,this.var_293);
         this.createGroupsFromXmlList(_loc8_,this.var_580,param1,param2,this.var_208,this.var_293);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_151);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_151,this.var_470,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_470);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_151,this.var_470);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_151,this.var_470);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1189);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_580.length)
         {
            _loc2_ = this.var_580[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_208 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_208.x = this.var_151 + this.var_1638;
               this.var_208.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_151;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_151;
               this._window.y = 0;
               this.var_208.x = 0;
               this.var_208.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_151;
               this._window.x = 0;
               this._window.y = 0;
               this.var_208.x = 0;
               this.var_208.y = this.var_151 + this.var_1638;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_151;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_151;
               this.var_208.x = 0;
               this.var_208.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1314;
         _loc4_ -= this.var_1076;
         var _loc5_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < this.var_242.length)
         {
            _loc3_ = this.var_242[_loc2_];
            _loc5_ += _loc3_.iconCount * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1076;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_242.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1639,(this._window.height - _loc5_ * _loc8_ - this.var_1076 - this.var_1314) / (this.var_242.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1639,(this._window.width - _loc5_ * _loc8_ - this.var_1076 - this.var_1314) / (this.var_242.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_242.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_470;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1077 && this.var_1315)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_470)
            {
               this.var_470 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_462);
                  _loc3_.orientation = this.var_470;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_151)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_151)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_151)
         {
            return "BOTTOM";
         }
         return null;
