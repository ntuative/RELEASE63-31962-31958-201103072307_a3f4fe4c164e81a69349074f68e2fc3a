package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_936:uint = 11;
      ...
      private var var_315:IAdManager;
      ...
      private var var_1092:IHabboWindowManager;
      ...
      private var var_246:PerformanceTracker = null;
      
      private var var_587:FramerateTracker = null;
      
      private var var_247:LatencyTracker = null;
      
      private var var_588:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_246 = new PerformanceTracker();
         this.var_587 = new FramerateTracker();
         this.var_247 = new LatencyTracker();
         this.var_588 = new LagWarningLogger();
         this.var_589 = new ToolbarClickTracker(this);
         this.var_1331 = new Array(const_936);
         var _loc4_:int = 0;
         while(_loc4_ < const_936)
         {
            this.var_1331[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1529,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1623,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_771,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1066,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_175)
            {
               this.var_175.release(new IIDHabboConfigurationManager());
               this.var_175 = null;
            }
            ...
            if(this.var_1092)
            {
               this.var_1092.release(new IIDHabboWindowManager());
               this.var_1092 = null;
            }
            if(this.var_315)
            {
            ...
            if(this.var_192)
            {
               ...
               {
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.const_351,this.onFriendlistTrackingEvent);
               }
               this.var_192.release(new IIDHabboFriendList());
               this.var_192 = null;
            }
            if(this.var_136)
            {
            ...
            if(this.var_171)
            {
               ...
               {
                  this.var_171.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
      ...
      {
         this.var_1331[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_175 = IHabboConfigurationManager(param2);
         if(this.var_175)
         {
            if(this.var_247 != null)
            {
               this.var_247.configuration = this.var_175;
            }
            if(this.var_246 != null)
            {
               this.var_246.configuration = this.var_175;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1600);
            if(this.var_175)
            {
               if(this.var_588 != null)
               {
                  this.var_588.configure(this.var_175);
               }
               if(this.var_587 != null)
               {
                  this.var_587.configure(this.var_175);
               }
               if(this.var_589 != null)
               {
                  this.var_589.configure(this.var_175);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_897,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_801,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_73,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_542,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_246 != null)
            {
               this.var_246.connection = param1;
            }
            if(this.var_247 != null)
            {
               this.var_247.communication = this._communication;
               this.var_247.connection = param1;
            }
            if(this.var_588 != null)
            {
               this.var_588.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_801)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1530);
         }
         else if(param1.type == HabboHotelViewEvent.const_542)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1644);
         }
         else if(param1.type == HabboHotelViewEvent.const_73)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1504);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1448);
               break;
            case HabboCommunicationEvent.const_897:
               this.trackLoginStep(HabboLoginTrackingStep.const_1642,String(this._communication.port));
               break;
      ...
      {
         this.var_1092 = IHabboWindowManager(param2);
         if(this.var_1092)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_175)
            {
               if(this.var_175.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_175.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1331)
                  {
                  ...
                  if(this.var_246 != null)
                  {
                     _loc4_["null"] = this.var_246.flashVersion;
                     _loc4_["null"] = this.var_246.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1148);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1148,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_192 = param2 as IHabboFriendList;
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.const_351,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_351:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2293)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1468);
            this.var_2293 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1066,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_285,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_315 = param2 as IAdManager;
         this.var_315.events.addEventListener(AdEvent.const_553,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_171 = param2 as IHabboToolbar;
         this.var_171.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      {
         if(this.var_175 != null && !Boolean(this.var_175.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_588.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_475 > -1 && _loc2_ < this.var_475)
         {
            ++this.var_1671;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1671);
         }
         if(this.var_475 > -1 && _loc2_ - this.var_475 > 15000)
         {
            ++this.var_1672;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1672);
         }
         this.var_475 = _loc2_;
         if(this.var_246 != null)
         {
            this.var_246.update(param1,this.var_475);
         }
         if(this.var_247 != null)
         {
            this.var_247.update(param1,this.var_475);
         }
         if(this.var_587 != null)
         {
            this.var_587.trackUpdate(param1,this,this.var_475);
         }
         if(this.var_588 != null)
         {
            this.var_588.update(this.var_475);
         }
      }
   }
}
