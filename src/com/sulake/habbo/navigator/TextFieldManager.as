package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_77.addEventListener(WindowKeyboardEvent.const_201,this.checkEnterPress);
         this.var_77.addEventListener(WindowEvent.const_109,this.checkMaxLen);
         this.var_2567 = this.var_77.textBackground;
         this._orgTextBackgroundColor = this.var_77.textBackgroundColor;
         this.var_2566 = this.var_77.textColor;
      }
      ...
      {
         this.var_77.textBackground = this.var_2567;
         this.var_77.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_77.textColor = this.var_2566;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_77.text = this.var_1265;
            this.var_625 = true;
         }
         else
         {
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_77.text = this.var_2565;
         this.var_625 = false;
         this.restoreBackground();
      }
