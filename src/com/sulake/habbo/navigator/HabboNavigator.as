package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_582:RoomInfoViewCtrl;
      
      private var var_1081:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_393:Tabs;
      ...
      private var var_2126:RoomThumbnailRenderer;
      
      private var var_826:GuestRoomPasswordInput;
      
      private var var_281:GuestRoomDoorbell;
      
      private var var_1080:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_582 = new RoomInfoViewCtrl(this);
         this.var_1081 = new RoomCreateViewCtrl(this);
         this.var_2126 = new RoomThumbnailRenderer(this);
         this.var_826 = new GuestRoomPasswordInput(this);
         this.var_281 = new GuestRoomDoorbell(this);
         this.var_393 = new Tabs(this);
         this.var_1080 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_307,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_582.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_175.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_290.startSearch(Tabs.const_271,Tabs.const_405,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_290.startSearch(Tabs.const_297,Tabs.const_218);
         this.var_393.getTab(Tabs.const_297).tabPageDecorator.tabSelected();
      }
