package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1040:int = 4;
      
      private static const const_949:int = 1;
      
      private static const const_600:int = 2;
      
      private static const const_948:int = 3;
      
      private static const const_1328:int = 4;
      ...
      private var var_916:PopularTagsListCtrl;
      
      private var var_917:GuestRoomListCtrl;
      
      private var var_1156:OfficialRoomListCtrl;
      ...
      private var var_1158:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_916 = new PopularTagsListCtrl(this._navigator);
         this.var_917 = new GuestRoomListCtrl(this._navigator);
         this.var_1156 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_245 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_245)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_177 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_219 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_198 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_257 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1398 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1158 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1158)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1158.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_16.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_245.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_647,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1665,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_177,["custom_content","list_content"],this.var_219.y,8);
         this.var_198.height = this.var_198.height + _loc1_ - this.var_198.y - this.var_257.height + this.var_2525;
         Util.moveChildrenToColumn(this.var_177,["list_content","custom_footer"],this.var_198.y,0);
         this.var_2525 = this.var_257.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_245.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1789 = true;
            this.var_245.selector.setSelected(_loc1_.button);
         }
      }
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_257);
      ...
      {
         this.refreshList(param1,param2,this.var_917,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_916,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1156,"official_rooms");
      }
      ...
      {
         if(param1 == Tabs.const_627)
         {
            return new MyFavouriteRoomsSearchMessageComposer();
         }
         if(param1 == Tabs.const_830)
         {
            return new MyFriendsRoomsSearchMessageComposer();
         }
         if(param1 == Tabs.const_811)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_614 == const_949)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_198.blend - _loc2_));
            this.var_198.blend = _loc3_;
            this.var_219.blend = !!this.var_1157 ? Number(_loc3_) : Number(1);
            this.var_257.blend = !!this.var_1157 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_614 = const_600;
            }
         }
         else if(this.var_614 == const_600)
         {
            ...
            {
               this.var_614 = const_948;
            }
         }
         else if(this.var_614 == const_948)
         {
            this.refresh();
            this.var_614 = const_1328;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_916);
         this.refreshScrollbar(this.var_917);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1158,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1158,"icon_hotelview_reactive",param1,null,0);
      }
