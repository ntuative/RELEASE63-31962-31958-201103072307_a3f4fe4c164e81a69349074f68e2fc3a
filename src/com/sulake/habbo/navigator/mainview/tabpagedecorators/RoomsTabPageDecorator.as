package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_262,Tabs.const_359);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_262,Tabs.const_694);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_262,Tabs.const_359,"" + _loc3_);
         }
      }
   }
}
