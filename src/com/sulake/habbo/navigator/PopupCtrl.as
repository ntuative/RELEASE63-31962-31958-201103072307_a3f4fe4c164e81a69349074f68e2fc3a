package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_423 = new Timer(500,1);
         this.var_365 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1001 = param4;
         this.var_2139 = param2;
         this._popupIndentLeft = param3;
         this.var_423.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_423)
         {
            this.var_423.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_423.reset();
            this.var_423 = null;
         }
         if(this.var_365)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_55 == null)
         {
            this.var_55 = IWindowContainer(this._navigator.getXmlWindow(this.var_1001));
            this.var_55.visible = false;
            this.var_55.setParamFlag(HabboWindowParam.const_39,true);
         ...
         this.var_55.x = _loc2_.x + this.var_2139 + param1.width;
