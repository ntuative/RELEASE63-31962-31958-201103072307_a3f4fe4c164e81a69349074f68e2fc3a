package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1177:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_631 = new Timer(100);
         this.var_631.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,80,"g"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,74,"h"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,416,"o"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,352,"p"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,304,"q"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,336,"r"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,748,"u"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_41,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_631)
         {
            this.var_631.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_631.reset();
            this.var_631 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1177.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1857 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1857 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_60 = IItemListWindow(this.var_177.findChildByName("item_list"));
         ...
         this.var_1178 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_177.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1178.goBackToInitialState();
         this.var_1178.input.textBackgroundColor = 4294967295;
         this.var_1177 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         if(this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_41))
         {
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_55:
               return true;
            case HabboClubLevelEnum.const_41:
               return this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_41);
            case HabboClubLevelEnum.const_44:
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_63,HabboWindowStyle.const_31,HabboWindowParam.const_59,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1178.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1178.getText();
         var _loc3_:String = "model_" + this.var_1177.name;
