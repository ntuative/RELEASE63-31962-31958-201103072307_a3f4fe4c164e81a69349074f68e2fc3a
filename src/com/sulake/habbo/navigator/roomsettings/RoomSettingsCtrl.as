package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_668:TextFieldManager;
      ...
      private var var_2074:ITextWindow;
      ...
      {
         this.var_328 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_328));
      ...
      {
         if(param1 != this.var_328 || this.var_1013 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1013 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1614)
         {
            this.var_668.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1503)
         {
            this.var_668.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1483)
         {
            this.var_1012.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1577)
         {
            this.setTagError(this.var_825,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_827,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1650)
         {
            this.setTagError(this.var_825,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_827,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1464)
         {
            this.var_826.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_668.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_516,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_677,this.onDoorModePasswordUnselect);
         ...
         this.var_668 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1012 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_825 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_827 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_826 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1015 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1011 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1016 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1014 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_549 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1540 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1273 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1019 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1018 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1543 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1272 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_235 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1017 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2074 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2075 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1542 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1542.procedure = this.onSwitchView;
         this.var_1017.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1540.visible = this._inRoom;
         this.var_1543.visible = this._inRoom;
         this.var_2075.visible = this.var_458;
         this.var_2074.visible = !this.var_458;
         if(this.var_458)
         {
            this.var_1018.visible = true;
            this.var_1272.visible = false;
            this.refreshFlatControllers();
            this.var_1018.height = Util.getLowestPoint(this.var_1018) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1273.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1273.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1019.height = Util.getLowestPoint(this.var_1019) + 4;
         }
         this.var_1542.text = !!this.var_458 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1540.name,this.var_1273.name,this.var_1019.name,this.var_1018.name,this.var_1272.name,this.var_1543.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_668.setText(_loc1_.name);
         this.var_1012.setText(_loc1_.description);
         this.var_826.setText("");
         ...
         this.setTag(this.var_825,_loc1_.tags[0]);
         this.setTag(this.var_827,_loc1_.tags[1]);
         if(this.var_1011)
         {
            if(_loc1_.allowPets)
            {
               this.var_1011.select();
            }
            else
            {
               this.var_1011.unselect();
            }
         }
         if(this.var_1016)
         {
         ...
         if(this.var_1014)
         {
            ...
            {
               this.var_1014.select();
            }
            else
            {
               this.var_1014.unselect();
            }
         }
         if(this.var_549)
         {
            ...
            {
               this.var_549.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_549.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_668.getText();
         _loc2_.description = this.var_1012.getText();
         ...
         {
            _loc8_ = this.var_826.getText();
            _loc9_ = this.var_1015.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_826.clearErrors();
               this.var_1015.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1011.isSelected;
         _loc2_.allowFoodConsume = this.var_1016.isSelected;
         _loc2_.allowWalkThrough = this.var_1014.isSelected;
         _loc2_.hideWalls = this.var_549.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_825,_loc2_.tags);
         this.addTag(this.var_827,_loc2_.tags);
         this.clearErrors();
         this.var_1013 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_328);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_79.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_328]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_235.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_235.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_235.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_235.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_235.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_235.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_235.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_235);
         this.var_235.findChildByName("ruler").visible = true;
         ...
         if(this.var_79.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_235,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_63,HabboWindowStyle.const_31,HabboWindowParam.const_59,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_328));
      }
