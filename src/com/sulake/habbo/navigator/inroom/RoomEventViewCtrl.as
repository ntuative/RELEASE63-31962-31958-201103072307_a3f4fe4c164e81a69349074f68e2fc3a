package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1912:IWindowContainer;
      
      private var var_2695:ITextWindow;
      
      private var var_1911:ITextWindow;
      
      private var var_1913:ITextWindow;
      
      private var var_1472:IButtonWindow;
      
      private var var_1471:IButtonWindow;
      
      private var var_2696:IButtonWindow;
      ...
      {
         this.var_967.visible = false;
         this.var_1912.visible = true;
         this.var_2695.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_787.setText(param1.eventDescription);
         this.var_825.setText(this.getTagFromEvent(param1,1));
         this.var_827.setText(this.getTagFromEvent(param1,2));
         this.var_1472.visible = false;
         this.var_1471.visible = true;
         this.var_1473.visible = true;
         this.var_1911.visible = false;
         this.var_1913.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_967.visible = true;
         this.var_1912.visible = false;
         this.var_1472.visible = true;
         this.var_1471.visible = false;
         this.var_1473.visible = false;
         this.var_787.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_825.goBackToInitialState();
         this.var_827.goBackToInitialState();
         this.var_967.selection = 0;
         this.var_1911.visible = true;
         this.var_1913.visible = false;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_787.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_825.getText());
         this.addTag(_loc6_,this.var_827.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_787.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1912 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2695 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1911 = ITextWindow(this.find("create_caption"));
            this.var_1913 = ITextWindow(this.find("edit_caption"));
            this.var_1472 = IButtonWindow(this.find("create_button"));
            this.var_1471 = IButtonWindow(this.find("edit_button"));
            this.var_2696 = IButtonWindow(this.find("cancel_button"));
            this.var_1473 = IButtonWindow(this.find("end_button"));
            this.var_967 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1472,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1471,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1473,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2696,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_787 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_825 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_827 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
