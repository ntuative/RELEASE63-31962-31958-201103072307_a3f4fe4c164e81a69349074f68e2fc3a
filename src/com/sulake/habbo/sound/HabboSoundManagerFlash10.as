package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_971:Map;
      
      private var var_789:int;
      
      private var var_972:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1074,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_971.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_971.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_175.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_175.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_647.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_788.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_788,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_973.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_973 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_175 == null || this._connection == null || this._roomEngine == null || this.var_646 != null)
         {
            return;
         }
         this.var_646 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_647.getValue(_loc2_);
         ...
         this.var_647.remove(_loc2_);
         this.var_788.add(_loc3_,_loc6_);
         if(this.var_647.length == 0 && this.var_789 != -1)
         {
            this.var_972.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1074,this.var_789));
            this.var_789 = -1;
            this.var_972 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_646.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1383,this.var_789));
         this.var_789 = -1;
         this.var_972 = null;
      }
      ...
      {
         this._volume = param1;
         this.var_646.updateVolume(this._volume);
