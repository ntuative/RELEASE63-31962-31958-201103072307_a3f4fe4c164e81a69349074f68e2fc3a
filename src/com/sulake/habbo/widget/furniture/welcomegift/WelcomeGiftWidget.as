package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_946:String = "welcome_gift_email_unverified";
      
      private const const_1698:String = "welcome_gift_email_verified";
      
      private const const_1314:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1377)
         {
            this.setViewState(this.const_1698);
         }
         else
         {
            this.setViewState(this.const_946);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_946:
               ...
               this.var_17.findChildByName("email").caption = this.var_1136;
               break;
            case this.const_1314:
      ...
      {
         this.setViewState(this.const_1314);
      }
      ...
      {
         this.setViewState(!!this.var_1377 ? this.const_1698 : this.const_946);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1136 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1136));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_111,this.updateEventHandler);
         param1.addEventListener(RoomWidgetEmailUpdateEvent.const_551,this.emailChangeHandler);
         param1.addEventListener(RoomWidgetEmailUpdateEvent.const_461,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_111,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetEmailUpdateEvent.const_551,this.emailChangeHandler);
         param1.removeEventListener(RoomWidgetEmailUpdateEvent.const_461,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_111:
               this.var_1136 = param1.email;
               this.var_1377 = param1.isVerified;
               this.var_2228 = param1.allowEmailChange;
               this.createMainView();
         }
      }
      ...
      private function emailChangeHandler(param1:RoomWidgetEmailUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEmailUpdateEvent.const_551:
               this.setViewState(this.const_946);
               break;
            case RoomWidgetEmailUpdateEvent.const_461:
