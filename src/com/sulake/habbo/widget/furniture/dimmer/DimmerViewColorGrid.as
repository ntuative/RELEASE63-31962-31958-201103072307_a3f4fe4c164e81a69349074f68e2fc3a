package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_465:IItemGridWindow;
      
      private var var_17:DimmerView;
      
      private var var_1594:XML;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_465.numGridItems)
         {
            return;
         }
         this.select(this.var_465.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this.var_17 == null || this.var_465 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_465.destroyGridItems();
         this.var_367 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_1594) as IWindowContainer;
            ...
            _loc3_.width = this.var_561.width;
            _loc3_.height = this.var_561.height;
            this.var_465.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_561.width,this.var_561.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_561,this.var_561.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1045.width,this.var_1045.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_848.width,this.var_848.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_848,this.var_848.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_465.getGridItemIndex(param1.target as IWindow);
