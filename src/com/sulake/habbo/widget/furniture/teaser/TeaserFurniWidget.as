package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1714:int = 0;
      
      private const const_1713:int = 1;
      
      private const const_1712:int = 2;
      
      private const const_1715:int = 3;
      
      private const const_1710:int = 4;
      
      private const const_2014:int = 0;
      
      private const const_2015:int = 1;
      
      private const const_2009:int = 2;
      
      private const const_2008:int = 3;
      
      private const const_2013:int = 4;
      
      private const const_2016:int = 5;
      
      private const const_1711:String = "deco_img";
      
      private const const_1709:String = "dialog_bg";
      
      private const const_2010:String = "%campaign%_dialog_bg.png";
      
      private const const_329:String = "%campaign%_gift_package.png";
      
      private const const_2011:String = "%campaign%_gift_content.png";
      
      private const const_2012:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1449 = this.var_160.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1449 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1447.length)
         {
            _loc2_ = this.var_1447.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_160 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_490,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_757,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_490,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_490:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_678:
               ...
               this._shareId = null;
               this.var_1448 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_757:
               _loc2_ = this.const_1713;
               this.var_353 = param1.objectId;
         ...
         if(this._window && (this.var_1446 != _loc2_ || _loc3_ != this.var_178))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_178 = _loc3_;
         this.var_1446 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1446)
            {
               ...
               case this.const_1713:
                  if(this.var_386 == this.const_2014)
                  {
                  ...
                  else if(this.var_386 == this.const_2015)
                  {
                  ...
                  else if(this.var_386 == this.const_2009)
                  {
                  ...
                  else if(this.var_386 == this.const_2008)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_386 == this.const_2013)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_178,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_386 == this.const_2016)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2010.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc5_,this.const_1709);
            _loc2_ = _loc2_.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc2_,this.const_1711);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_891);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_160.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_160);
            _loc2_.objectId = this.var_353;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         if(this._inventory)
         {
            if(this.var_1448 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1448 == 1 ? "null" : InventoryCategory.const_134);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_620,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1447.push(new ImageDownloader(this,_assets,this.var_178,this.var_1449,param1,param2));
            return;
         }
