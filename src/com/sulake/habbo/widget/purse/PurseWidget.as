package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      {
         this.var_2323 = param1.balance;
         if(this.var_17)
         {
            this.var_17.findChildByName("credits").caption = this.var_2323.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2561 = param1.balance;
         if(this.var_17)
         {
            this.var_17.findChildByName("pixels").caption = this.var_2561.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1136));
      }
