package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_954:int = 150;
      
      private static const const_955:int = 250;
      ...
      private var var_2544:BitmapData;
      ...
      private var var_2545:BitmapData;
      
      private var var_2543:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_39 = param3;
         this.var_2544 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1812 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2541 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1813 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1814 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2542 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2545 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_76 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_307,HabboWindowStyle.const_31,HabboWindowParam.const_59,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_39.addChild(this.var_76);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_63,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_39.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_39.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_486,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onCloseButtonMouseOut);
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_565:
               this.var_76.blend += param1 / const_955;
               this._window.blend += param1 / const_955;
               if(this._window.blend >= 1)
               {
                  this.state = const_388;
               }
               break;
            case const_917:
               this.var_76.blend -= param1 / const_954;
               this._window.blend -= param1 / const_954;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_39.width - this.var_2543;
         }
         if(this.var_76 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2540 == this._window.width)
         {
            return;
         }
         this.var_2540 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2541;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1813;
            _loc2_.disposesBitmap = false;
            this.var_2543 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2544,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1812,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1812,_loc9_);
         ...
         this.var_76.bitmap = this.var_2545;
