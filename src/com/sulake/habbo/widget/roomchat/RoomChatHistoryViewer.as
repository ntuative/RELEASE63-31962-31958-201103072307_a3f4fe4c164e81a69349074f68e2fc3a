package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1271:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1055:int = 3;
       
      
      private var var_174:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_758 = false;
         this._widget = param1;
         this.var_174 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_174.state = RoomChatHistoryPulldown.const_243;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_982,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_174.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_243);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_174.state == RoomChatHistoryPulldown.const_388 || this.var_174.state == RoomChatHistoryPulldown.const_565;
      }
      ...
      {
         if(!this.var_400 && !this.var_1748)
         {
            this.var_400 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_174.state = RoomChatHistoryPulldown.const_388;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_574;
            }
         }
         if(this.var_174 != null)
         {
            this.var_174.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_399 > 0 && param2)
         {
            if(this.var_1632)
            {
               if(Math.abs(param1 - this.var_399) <= const_1055)
               {
                  return;
               }
               this.var_1632 = false;
            ...
            if(this.var_400)
            {
               ...
               _loc5_ = (param1 - this.var_399) / this.var_49.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1271 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1631)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_574 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_574 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
