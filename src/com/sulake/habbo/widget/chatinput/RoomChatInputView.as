package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1249:int = 11;
      
      private static const const_588:int = 18;
      
      private static const const_912:int = 16;
      
      private static const const_1250:int = 20;
      ...
      private var var_304:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1024 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2086 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_329 = new Timer(1000,1);
         this.var_329.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_390 = new Timer(10000,1);
         this.var_390.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_329.reset();
            this.var_329.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_329 = null;
         }
         if(this.var_390 != null)
         {
            this.var_390.reset();
            this.var_390.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_390 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_201,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_109,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_354,this.onWindowMoved);
         this.var_1553 = true;
         this.var_459 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_588 + const_912;
         _loc1_.x = const_588;
         _loc1_.y = const_1249;
      }
      ...
      {
         this.var_304 = param1 - (const_588 + const_912);
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_45,this.windowMouseEventProcessor);
         }
      }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1024 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_459 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1250);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_459.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_459 = _loc2_.text;
            if(!this.var_552)
            {
               this.var_552 = true;
               this.var_329.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_552);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_304)
         {
