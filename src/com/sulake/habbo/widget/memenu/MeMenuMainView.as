   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
            ...
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_44)
                        {
         ...
         while(_loc5_ < this._window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseOverOrOut);
            _loc5_++;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1087));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_798);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1108));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_314);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1143));
               this._widget.hide();
               break;
            case "settings":
