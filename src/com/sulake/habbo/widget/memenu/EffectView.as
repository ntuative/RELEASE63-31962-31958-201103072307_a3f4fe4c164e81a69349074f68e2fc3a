package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_1987:int = 1000;
      
      private var _container:MeMenuEffectsView;
      
      private var _window:IWindowContainer;
      
      private var var_172:IWidgetAvatarEffect;
      
      private var var_852:IWindow;
      
      private var var_304:Number;
      
      private var var_697:ITextWindow;
      
      private var var_194:Timer;
      
      private var var_853:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_194 = new Timer(this.const_1987);
         this.var_194.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_194.stop();
            this.var_194.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_194 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_172.isActive)
         {
            _loc2_ = this.var_172.secondsLeft / Number(this.var_172.duration);
            this.var_852.width = _loc2_ * this.var_304;
         }
         else
         {
            this.var_852.width = 0;
            this.var_194.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_697 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_697 == null)
            {
               return;
            }
         ...
         if(!this.var_172.isActive)
         {
            this.var_697.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_697.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_697.text;
         var _loc2_:int = this.var_172.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_172.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_172.isActive)
         {
         ...
         else
         {
            ...
            this.var_853 = this._window.findChildByName("effect_hilite");
            this.var_853.visible = false;
         }
         this.setTimeLeft();
         this.var_852 = this._window.findChildByName("loader_bar");
         if(this.var_852 != null)
         {
            this.var_304 = this.var_852.width;
            this.var_194.start();
            this.onUpdate();
         }
         if(this.var_172.icon)
         {
            this.setElementBitmap("effect_icon",this.var_172.icon);
         }
      }
