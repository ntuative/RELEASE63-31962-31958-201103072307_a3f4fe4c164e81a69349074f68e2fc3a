package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_188:PetCommandTool;
      ...
      private const const_1973:int = 16;
      
      private const const_1246:int = 4;
      
      private const const_1974:uint = 14342874;
      
      private const const_1969:uint = 3815994;
      
      private const const_1976:uint = 2085362;
      
      private const const_1978:uint = 39616;
      
      private const const_1972:uint = 10513106;
      
      private const const_1975:uint = 8734654;
      
      private const const_1970:uint = 9094430;
      
      private const const_1979:uint = 6200576;
      
      private const const_1980:String = "happiness";
      
      private const const_1977:String = "experience";
      
      private const const_1971:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_189 == null || this.var_68 == null)
         {
            return;
         }
         this.var_68.width = this.var_68.scrollableRegion.width;
         this.var_68.visible = this.var_68.width > 0;
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_189.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_189.width,this.var_68.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_189.width < this.var_68.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1980,param1.nutrition,param1.nutritionMax,this.const_1978,this.const_1976);
         this.updateStateElement(this.const_1977,param1.experience,param1.experienceMax,this.const_1975,this.const_1972);
         this.updateStateElement(this.const_1971,param1.energy,param1.energyMax,this.const_1979,this.const_1970);
         ...
         this.updateWindow();
         this.var_510 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_188 && this.var_188.isVisible() && param1.isOwnPet)
         {
            this.var_188.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_188.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1981,this.const_1973,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1974);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1969);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1246,_loc7_.width - 2,_loc7_.height - 2 - this.const_1246);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1246);
      ...
      private function openTrainView() : void
      {
         if(this.var_188 == null)
         {
            this.var_188 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_510) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_188.showWindow(true);
            this.var_188.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_53 = this.var_189.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         _loc4_ = 0;
         while(_loc4_ < this.var_68.numListItems)
         {
            _loc12_ = this.var_68.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc12_ != null)
            {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_189.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_189.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_189.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         var _loc10_:* = [];
         this.var_68.groupListItemsWithTag("CMD_BUTTON",_loc10_,true);
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_50,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_188 && this.var_188.getPetId() == this.var_510)
               {
                  this.var_188.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1599,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_561,this._widget.petData.ownerId);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = this.var_68.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
