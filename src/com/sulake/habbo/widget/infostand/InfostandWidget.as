package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1705:String = "infostand_user_view";
      
      private const const_1706:String = "infostand_furni_view";
      
      private const const_1707:String = "infostand_pet_view";
      
      private const const_1708:String = "infostand_bot_view";
      
      private var var_1184:InfoStandFurniView;
      
      private var var_131:InfoStandUserView;
      
      private var var_369:InfoStandPetView;
      
      private var var_431:InfoStandBotView;
      
      private var var_2619:Array;
      
      private var var_1441:InfostandUserData;
      
      private var var_620:InfostandFurniData;
      ...
      private const const_2007:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1184 = new InfoStandFurniView(this,this.const_1706,this._catalog);
         this.var_131 = new InfoStandUserView(this,this.const_1705);
         this.var_369 = new InfoStandPetView(this,this.const_1707,this._catalog);
         this.var_431 = new InfoStandBotView(this,this.const_1708);
         this.var_1441 = new InfostandUserData();
         this.var_620 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_161 = new Timer(this.const_2007);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_357,this.onRoomObjectSelected);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_137,this.onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_289,this.onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_157,this.onUserTags);
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_156,this.onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_70,this.onUserBadges);
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_640,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_676,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_357,this.onRoomObjectSelected);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_137,this.onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_289,this.onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_157,this.onUserTags);
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_156,this.onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_70,this.onUserBadges);
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_640,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_676,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_341,this.var_369.getCurrentPetId()));
      }
      
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         this.userData.method_1(param1);
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1708);
         if(this.var_161)
         {
            this.var_161.stop();
         }
      ...
      {
         this.furniData.method_1(param1);
         this.var_1184.update(param1);
      ...
      {
         this.petData.method_1(param1);
         this.userData.petRespectLeft = param1.petRespectLeft;
         this.var_369.update(this.petData);
         this.selectView(this.const_1707);
         if(this.var_161)
         {
            this.var_161.start();
         }
      ...
      {
         this.var_369.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_131.setTags(param1.tags,this.var_2619);
         }
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_131.setBadgeImage(_loc2_,param1.badgeImage);
            }
            return;
         }
         var _loc4_:* = [];
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_373,param1.id,param1.category);
