package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_435:IFrameWindow;
      ...
      private const const_2018:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_376 = new Timer(this.const_2018);
         this.var_376.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1202.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_510);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1202.getValue(this.var_510) as CommandConfiguration;
      ...
      {
         this.var_1202.remove(param1);
         this.var_1202.add(param1,param2);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.context.getDesktopWindow().addEventListener(WindowEvent.const_50,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_435 == null)
         {
            ...
            this.var_435 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_435 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_435.x = 200;
            this.var_435.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_341,this.var_510));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_526,this.var_510,this.var_1901 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_526,this.var_510,this.var_1901 + " " + _loc5_);
