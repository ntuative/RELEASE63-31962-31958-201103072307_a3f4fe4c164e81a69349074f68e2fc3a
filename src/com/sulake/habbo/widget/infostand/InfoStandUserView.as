package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_165:IFrameWindow;
      
      private var var_649:IWindow;
      
      private var var_189:IBorderWindow;
      
      private var var_1094:TagListRenderer;
      
      private var var_135:IBorderWindow;
      
      private var var_2726:int;
      
      private const const_974:int = 5;
      
      private const const_1726:int = 39;
      
      private const const_1727:int = 7829367;
      
      private const const_1725:int = 16777215;
      
      private const const_2020:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1094 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_50,this.onButtonResized);
         }
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_189.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_189.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_189.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_189.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_974;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1727;
            }
            else
            {
               _loc3_.textColor = this.const_1725;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_974;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_378,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_378,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1094.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_120);
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_141:
               ...
               this.showButton("kick",(param1.amIOwner || param1.amIController || param1.amIAnyRoomController) && param1.method_2);
               this.showButton("ban",(param1.amIOwner || param1.amIAnyRoomController) && param1.method_2);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_996:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1082:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2726 > this.const_2020 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2726 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1727;
            if(_loc3_.length >= this.const_1726)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1726 - 1);
            }
         }
      }
      ...
      {
         this.var_165 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_165.center();
         this.var_165.procedure = this.badgesEventProc;
         this.var_165.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_165 && this.var_165.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_649 = null;
         var _loc2_:IItemGridWindow = this.var_165.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_165.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_165.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_649);
               }
               if(_loc3_ <= -1)
               {
                  return;
