package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1114:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1115 = 0;
         this.var_1114 = param2.rectangle.clone();
         this.var_1114.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1114.width)
         {
            return false;
         }
         if(this.var_1115 + param1.height > this.var_1114.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1114.width)
         {
            this._offsetX = 0;
            this.var_1115 += param1.height + this.const_2001;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1115);
         this._offsetX += param1.width + this.const_2002;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1359 != null && this.var_1359.indexOf(param1) != -1)
         {
