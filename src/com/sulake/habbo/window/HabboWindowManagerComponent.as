package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_415:uint = 3;
      
      private static const const_1306:uint = 1;
      ...
      private var var_879:IWindowRenderer;
      
      private var var_880:ISkinContainer;
      
      private var var_346:Array;
      
      private var var_1349:IEventDispatcher;
      
      private var var_1103:Boolean = false;
      
      private var var_1687:ProfilerOutput;
      
      private var var_1348:ProfilerAgentTask;
      
      private var var_1350:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_880 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_879 = new WindowRenderer(this.var_880);
         this.var_193 = new Array(const_415);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_415)
         {
            this.var_193[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_879,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_272 = this.var_193[const_1306];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1687)
            {
               this.var_1687 = new ProfilerOutput(context,this,this.var_879);
            }
            this.var_1687.profiler = _loc3_;
            this.var_1348 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1348);
            this.var_1350 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1350);
            this.var_1103 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_193)
            {
               while(this.var_193.length > 0)
               {
                  IDisposable(this.var_193.pop()).dispose();
               }
            }
            this.var_193 = null;
            if(this.var_346)
            {
               while(this.var_346.length > 0)
               {
                  this.var_346.pop();
               }
            }
      ...
      {
         return this.var_272.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_272.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_346[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_346[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_880.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_193[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_193[param2].getDesktopWindow();
      ...
      {
         return this.var_193[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_193[param1].getDesktopWindow().getChildAt(this.var_272.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_193[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_382.length > 0)
         {
            this.var_1349.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_415 - 1;
            while(_loc2_ >= 0)
            {
               this.var_193[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1103)
         ...
         this.var_1349.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_415)
         {
            this.var_193[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1103)
         {
         ...
         if(WindowContext.var_382.length > 0)
         {
            WindowContext.var_382.flush();
         }
         this.var_1349.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1606,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1431,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1382,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1537,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_478,
            "style":WindowStyle.const_181,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
