package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_214:ClubBuyConfirmationDialog;
      ...
      {
         this.closeConfirmation();
         this.var_214 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!this._catalog.getPurse().isVIP ? 0 : int(HabboClubLevelEnum.const_41);
         }
         return _loc1_;
      }
