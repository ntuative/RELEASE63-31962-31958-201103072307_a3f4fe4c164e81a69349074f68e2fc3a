package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_943:int = 0;
      ...
      {
         return this.var_601 != const_943;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1723 != RecyclerStatusMessageEvent.const_1112;
      }
      ...
      public function init(param1:IRecyclerVisualization = null) : void
      {
         ...
         this.var_113 = new Array(const_195);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_195)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_601 = const_943;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1723)
         {
            case RecyclerStatusMessageEvent.const_1454:
               this.var_601 = const_416;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1112:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1481:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1184:
               if(this.var_17 != null)
               {
                  this.var_17.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1435:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_113.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_195)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_113.length < const_195)
         {
            return false;
         }
         var _loc1_:int = 0;
