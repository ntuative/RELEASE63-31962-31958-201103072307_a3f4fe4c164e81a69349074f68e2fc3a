package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2005:int = 10;
      ...
      private const const_1718:uint = 4.293848814E9;
      
      private const const_1717:uint = 4.294967295E9;
      
      private const const_2004:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_85:
                  ...
                  break;
               case ProductTypeEnum.const_240:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1653 = _loc1_.stuffTypes;
            this.var_743 = _loc1_.boxTypes;
            this.var_742 = _loc1_.ribbonTypes;
            this.var_1153 = this.var_1653[0];
            this.var_356 = this.var_743[0];
            this.var_357 = this.var_742[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_357 < 0)
         {
            this.var_357 = this.var_742.length - 1;
         }
         if(this.var_357 > this.var_742.length - 1)
         {
            this.var_357 = 0;
         }
         if(this.var_356 < 0)
         {
            this.var_356 = this.var_743.length - 1;
         }
         if(this.var_356 > this.var_743.length - 1)
         {
            this.var_356 = 0;
         }
         var _loc1_:int = this.var_743[this.var_356] * 1000 + this.var_742[this.var_357];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1153,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1395 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1653;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_88);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1153);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_743[this.var_356]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_742[this.var_357]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1394,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1394);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_109:
               ...
               for each(_loc7_ in this.var_211)
               {
                  ...
                  if(_loc5_.length >= this.const_2005)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2519 = _loc3_.text;
               break;
            case WindowMouseEvent.const_45:
               ...
               break;
            case WindowKeyboardEvent.const_378:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_358 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_358 + 1);
                     break;
      ...
      {
         if(this.var_255 == null || !this.var_255.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_255.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_358) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_255 == null)
         {
            this.var_255 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_612 == null)
         {
            this.var_612 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_612.procedure = this.suggestionsEventHandler;
         }
         if(this.var_255 == null || this.var_612 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_255.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_612.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_358) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_358);
         }
         this.var_358 = param1;
         if(this.var_358 < 0)
         {
            this.var_358 = _loc2_.numListItems - 1;
         }
         if(this.var_358 >= _loc2_.numListItems)
         {
            this.var_358 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_358) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2004;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1718) : uint(this.const_1717);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_255.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1153;
               }
            }
            _loc4_++;
         }
