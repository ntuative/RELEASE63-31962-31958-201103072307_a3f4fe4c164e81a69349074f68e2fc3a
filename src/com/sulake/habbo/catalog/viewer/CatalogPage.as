package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1672:String = "ctlg_";
       
      
      protected var var_1992:XML;
      ...
      private var var_460:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1036:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_460 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1035);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1035);
      }
      ...
      {
         var _loc2_:String = const_1672 + param1;
         ...
         this.var_1992 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1992) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1588:
               if(this.var_1036 == null)
               {
                  this.var_1036 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1036);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1666:
               ...
               break;
            case CatalogWidgetEnum.const_1589:
               this.var_48.push(new PurchaseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1471:
            ...
            case CatalogWidgetEnum.const_1475:
               ...
               break;
            case CatalogWidgetEnum.const_1493:
            ...
            case CatalogWidgetEnum.const_1662:
               ...
               break;
            case CatalogWidgetEnum.const_1461:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_460.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_460 != null)
         {
            return this.var_460.dispatchEvent(param1);
         }
         return false;
      }
   }
