package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_109,this.onTextWindowEvent);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_203 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1325 && _loc2_ < this.var_203.length)
            {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_203 != null && this.var_203.length > 0)
         {
            ...
            this.var_355 = this.var_203[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_488,this.var_355),this.getRaceLocalizationKey(this.var_488,this.var_355));
            }
         }
         return this.getRaceLocalizationKey(this.var_488,this.var_355);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_355 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_488;
         var _loc3_:int = this.var_355;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_355 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
