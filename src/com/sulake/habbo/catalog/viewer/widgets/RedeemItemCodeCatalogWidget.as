package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_914.removeEventListener(WindowKeyboardEvent.const_201,this.windowKeyEventProcessor);
            this.var_914 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_914 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_914 != null)
         {
            this.var_914.addEventListener(WindowKeyboardEvent.const_201,this.windowKeyEventProcessor);
         }
         return true;
      }
