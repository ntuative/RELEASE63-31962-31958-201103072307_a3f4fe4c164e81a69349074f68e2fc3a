package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1137:ITextWindow;
      
      private var var_87:IBitmapWrapperWindow;
      
      private var var_1733:Point;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_895 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1137 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1733 = new Point(this.var_87.x,this.var_87.y);
         this.var_486 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         ...
         this.var_1734 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_895.text = _loc4_;
         this.var_1137.text = _loc5_;
         this.var_895.height = this.var_895.textHeight + 5;
         this.var_1137.y = this.var_895.y + this.var_895.height;
         this.var_1137.height = Math.max(130,this.var_1137.textHeight + 5);
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            this.setPreviewFromAsset(ProductImageConfiguration.const_28[_loc2_.localizationId]);
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_438:
                  _loc6_ = this.var_1734.clone();
                  if(this.var_486 != null)
                  {
                     this.var_486.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_486,this.var_1379,this.var_1636);
                     this.var_486.scrollV = 0;
                  }
                  break;
               case Offer.const_424:
               case Offer.const_515:
                     ...
                     case ProductTypeEnum.const_240:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_322,AvatarAction.const_456);
                              _loc16_.appendAction(AvatarAction.const_275,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2445)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2445 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_87 != null && true)
         {
            ...
            this.var_87.x = this.var_1733.x;
            this.var_87.y = this.var_1733.y;
            if(param3 != null)
            {
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_27,this.onPreviewImageReady);
      }
