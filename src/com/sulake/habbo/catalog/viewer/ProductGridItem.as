package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_935:String = "bg";
       
      
      protected var var_17:IWindowContainer;
      
      private var var_248:IItemGrid;
      ...
      {
         this.var_17.getChildByName(const_935).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this.var_17.getChildByName(const_935).style = 3;
      }
