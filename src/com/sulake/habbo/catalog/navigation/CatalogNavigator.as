package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2848:String = "magic.credits";
      
      private var var_2812:String = "magic.pixels";
      
      private var var_2811:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onNavigatorEvent);
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_371.indexOf(param1) > -1;
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_371.indexOf(_loc6_);
            this.var_371.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_371.indexOf(param1) == -1)
         {
      ...
      {
         this.openPage(this.var_2812);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2811,true);
      }
