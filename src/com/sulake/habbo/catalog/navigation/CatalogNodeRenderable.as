package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1368:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1478:XML;
      
      private static var var_1479:XML;
       
      
      private var var_1927:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1927 == 4294967295)
            {
               this.var_1927 = _loc1_.color;
            }
            _loc1_.color = const_1368;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1463;
            }
         }
      }
      ...
      {
         this.var_60 = navigator.catalog.windowManager.buildFromXML(var_1479) as IItemListWindow;
         if(this.var_60 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1478) as IWindowContainer;
         }
         else
         {
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_27,this.onIconImageReady);
      }
