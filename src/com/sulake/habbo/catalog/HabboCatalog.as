package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_516:IAvatarRenderManager;
      
      private var var_600:IHabboSoundManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_736:Boolean = false;
      
      private var var_296:CatalogViewer;
      
      private var var_349:ICatalogNavigator;
      
      private var var_99:Purse;
      
      private var var_92:RecyclerLogic;
      
      private var var_125:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_214:PurchaseConfirmationDialog;
      
      private var var_295:ChargeConfirmationDialog;
      ...
      private var var_2410:Boolean = true;
      
      private var var_2409:Boolean = true;
      
      private var var_1719:Boolean = false;
      
      private var var_2411:GiftWrappingConfiguration;
      
      private var var_1127:ClubGiftController;
      
      private var _clubBuyController:ClubBuyController;
      
      private var var_728:Map;
      
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_728 = new Map();
         super(param1,param2,param3);
         this.var_99 = new Purse();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_600)
         {
            this.var_600.release(new IIDHabboSoundManager());
            this.var_600 = null;
         }
         if(this.var_299)
         {
         ...
         if(this.var_516)
         {
            this.var_516.release(new IIDAvatarRenderManager());
            this.var_516 = null;
         }
         if(this.var_175)
         {
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_99.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_99.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_214 == null)
            {
               this.var_214 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_214.showOffer(this,param1,param2,param3,_loc4_);
      ...
      {
         this.var_175 = param2 as IHabboConfigurationManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_516 = param2 as IAvatarRenderManager;
      }
      ...
      {
         this.var_600 = param2 as IHabboSoundManager;
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_349.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_175.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_175.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_299.getProductData(param1);
      }
      
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_88)
         {
            _loc3_ = this.var_299.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_85)
         {
            _loc3_ = this.var_299.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_728.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_99.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_99.getActivityPointsForType(Purse.const_183)));
         var _loc1_:int = 0;
         if(!this.var_99.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_99.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_99.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_99.clubPeriods));
         }
      ...
      {
         this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_736)
         {
            if(!this.var_299.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_171 != null && _loc2_)
         {
            this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_296.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_349 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_296 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_296.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_229,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1719 = param1.session.isPrivateRoom;
               if(this.var_92 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_125 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1127 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_349.buildCatalogIndex(_loc2_);
         if(this.var_727 && this.var_727 != "")
         {
            this.var_349.openPage(this.var_727);
            this.var_727 = "";
            this.var_888 = -1;
         }
         else if(this.var_888 > -1)
         {
            this.var_349.openPageById(this.var_888,this.var_1718);
            this.var_888 = -1;
            this.var_1718 = -1;
            this.var_727 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_296.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_296 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_296.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_99.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2410 && this.var_600 != null)
         {
            this.var_600.playSound(HabboSoundTypesEnum.const_1005);
         }
         this.var_2410 = false;
         if(this.var_295 != null)
         {
            this.var_295.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_67,this.var_99.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_99.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2409 && this.var_600 != null)
         {
            this.var_600.playSound(HabboSoundTypesEnum.const_1215);
         }
         this.var_2409 = false;
         if(this.var_295 != null)
         {
         ...
         if(_loc2_.type == Purse.const_183)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_108,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_99.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_108,_loc2_.points["null"]));
         }
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_99.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_99.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_99.isVIP = _loc2_.isVIP;
         this.var_99.pastClubDays = _loc2_.pastClubDays;
         this.var_99.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1127.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_296.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_125 != null)
         {
            this.var_125.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_125 != null)
         {
            this.var_125.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_125 != null)
         {
            this.var_125.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2411 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_214 != null)
         {
            this.var_214.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_125.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_295 == null)
         {
            this.var_295 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_295.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_728.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_728.add(_loc2_.productCode,_loc3_.slice());
            this.var_296.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_175.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_175.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_199)
         {
            _loc3_ = this.var_175.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
