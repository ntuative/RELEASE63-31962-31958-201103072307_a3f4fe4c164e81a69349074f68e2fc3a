package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1539:uint = 1;
      
      public static const const_1610:uint = 2;
       
      
      private var var_1336:IProtocolEncoder;
      ...
      {
         super();
         this.var_1336 = new WedgieEncoder();
         this.var_1078 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1336.dispose();
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1539)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1078.getID(_loc4_);
