package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1703:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_65 = param1;
         this._communication = this.var_65.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_65.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_65.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_65.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:String = this.var_65.configuration.getKey("questing.excludedCampaignCode","");
         if(this.var_65.defaultCampaignCode == _loc4_)
         {
            this.var_65.defaultCampaignCode = "";
         }
         ...
         else
         {
            ...
            this.var_65.controller.openCampaigns(_loc3_);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_65.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(this.var_65.toolbar != null && this.var_65.configuration != null)
         {
            this.var_65.defaultCampaignCode = this.getCampaignCode();
      ...
      {
         var _loc1_:String = this.var_65.configuration.getKey("questing.defaultCampaign","");
         var _loc2_:String = this.var_65.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_65.configuration.getKey("questing.excludedCampaignCode","");
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_65.toolbar != null)
         {
            if(param1)
            {
               _loc2_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_87,HabboToolbarIconEnum.QUESTS);
               _loc3_ = this.var_65.defaultCampaignCode;
               _loc4_ = _loc3_.length > 0 && _loc3_ == this.var_65.configuration.getKey("questing.defaultCampaign.override","");
               if(this.var_65.habboHelp && _loc4_)
               {
                  _loc5_ = new HabboHelpSetWelcomeScreenCategoryEvent(HabboToolbarIconEnum.QUESTS,"questing");
                  this.var_65.habboHelp.events.dispatchEvent(_loc5_);
               }
               this.var_65.toolbar.events.dispatchEvent(_loc2_);
               this._communication.getHabboMainConnection(null).send(new GetExpiredQuestCampaignsMessageComposer());
            }
            else
            {
               this.var_65.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_65.controller.updatePurse();
      }
