package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1822:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_93.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestTypeFindStuff");
               this.var_1822 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            case QuestTypeEnum.GIVE_BADGE:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestTypeGiveBadge");
               this.var_1822 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            default:
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_93)
         {
            this.var_61.controller.activateQuest(this.var_93);
         }
      }
      ...
      public function onRewardInfo(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(this.var_93)
         {
            _loc3_ = "catalog.page.quest." + this.var_61.code;
      ...
      private function localize() : void
      {
         ...
         var _loc37_:* = null;
         var _loc38_:* = null;
         var _loc1_:String = ["quest",this.var_61.code,this.var_93.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_61.code,"type_" + this.var_93.type.toLowerCase()].join(".");
         ...
         if(this.var_93.type == QuestTypeEnum.FIND_STUFF)
         {
            ...
            _loc36_ = this.var_61.controller.questEngine.sessionDataManager.getFloorItemDataByName(_loc34_,_loc35_);
            if(_loc36_)
            {
               _loc38_ = "";
               _loc37_ = this.var_61.controller.questEngine.roomEngine.getFurnitureImage(_loc36_.id,new Vector3d(90,0,0),64,this,_loc35_,_loc38_);
               this.var_1823 = _loc37_.id;
               if(_loc37_ && _loc37_.data)
               {
                  this.imageReady(_loc37_.id,_loc37_.data);
               }
               this.var_61.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc36_.title);
            }
         }
         else if(this.var_93.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_61.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_93.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_61.controller.questEngine.setImageFromAsset(_loc15_,this.var_93.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else
         {
            this.var_1823 = -1;
         ...
         {
            case QuestStatusEnum.const_554:
            ...
            case QuestStatusEnum.const_194:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_797:
               this.setText("quest.status","quest.completed");
               _loc17_.visible = true;
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_193:
         ...
         this.var_61.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_93.rewardCurrencyAmount.toString());
         ...
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","day",_loc20_.toString());
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","month",_loc21_.toString());
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","year",_loc22_.toString());
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","12h",this.pad(_loc25_));
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","24h",this.pad(_loc24_));
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","ampm",_loc26_);
         this.var_61.controller.questEngine.localization.registerParameter("quest.available","minute",this.pad(_loc23_));
         ...
         var _loc30_:String = "header_" + this.var_61.code;
         this.var_61.controller.questEngine.setImageFromAsset(_loc29_,_loc30_,this.onHeaderImageReady);
         var _loc31_:IBitmapWrapperWindow = this.find("quest.reward.icon") as IBitmapWrapperWindow;
         var _loc32_:String = "icon_" + this.var_61.code + "_reward_" + this.var_93.rewardCurrencyAmount;
         this.var_61.controller.questEngine.setImageFromAsset(_loc31_,_loc32_,this.onRewardImageReady);
         this.updateMargins();
      }
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_637;
            }
         }
      }
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_61.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
      ...
      private function onHeaderImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_61.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onHeaderImageReady);
         }
      }
