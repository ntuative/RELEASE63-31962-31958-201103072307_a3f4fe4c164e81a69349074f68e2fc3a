package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_316:QuestCampaign;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_163)
         {
            for each(_loc1_ in this.var_163)
            {
               _loc1_.dispose();
            }
      ...
      {
         var _loc3_:QuestCampaign = this.var_163[param1];
         if(!_loc3_)
         {
            _loc3_ = new QuestCampaign(this,param1);
            this.var_163[param1] = _loc3_;
         }
         if(_loc3_)
         {
      ...
      public function openCampaign(param1:String, param2:int, param3:Array) : void
      {
         ...
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_163[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_163[param1] = _loc4_;
         }
         _loc4_.activityPointType = param2;
         this.var_316 = _loc4_;
         this.var_316.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_609 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_316.attachTo(this.var_1205);
         var _loc1_:String = "quest_" + this.var_316.code;
      ...
      public function openCampaigns(param1:Array, param2:Boolean = false) : void
      {
         ...
         {
            _loc4_ = this.var_163[_loc3_];
            if(!_loc4_)
            {
               _loc4_ = new QuestCampaign(this,_loc3_);
               this.var_163[_loc3_] = _loc4_;
            }
      ...
      private function updateTabs() : void
      {
         ...
         if(this.var_316)
         {
            _loc1_ = this.var_316.code;
         }
         else if(this.var_65.defaultCampaignCode.length > 0)
         {
            _loc1_ = this.var_65.defaultCampaignCode;
         }
         else if(this.var_163.getKeys().length > 0)
         {
            _loc1_ = this.var_163.getKeys()[0];
         }
         if(_loc1_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1205 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_163.getKeys())
         {
            _loc3_ = this.var_163[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc6_ = "quest_" + _loc4_ + ".tab";
               _loc2_ = this.var_65.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_489) as ITabButtonWindow;
               if(_loc3_.expired)
               {
               ...
               _loc2_.addEventListener(WindowEvent.const_60,this.onTabSelect);
            }
            _loc5_ = 4287150640;
            if(_loc3_.expired)
            {
