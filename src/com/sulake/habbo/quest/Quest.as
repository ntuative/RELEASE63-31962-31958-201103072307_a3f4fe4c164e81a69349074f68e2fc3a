package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1326:uint = 7645971;
      
      private var var_1660:uint = 6710886;
      
      private var var_189:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1844 = param1.roomItemTypeName;
         this.var_1846 = param1.rewardCurrencyAmount;
         this.var_1661 = new Date();
         this.var_1661.setTime(param1.endDateTimeStamp);
         this.var_764 = param1.localizationCode;
         this.var_2268 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         switch(this.var_386)
         {
            case QuestStatusEnum.const_47:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestEntityAccepted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_554:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestEntityAvailable") as IWindowContainer;
               break;
            case QuestStatusEnum.const_194:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
               break;
            case QuestStatusEnum.const_797:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestEntityCompleted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_193:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestEntityPreview") as IWindowContainer;
               break;
            default:
               this.var_17 = this.var_61.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
         }
         ...
         if(_loc1_ != null)
         {
            this.var_1326 = _loc1_.color;
         }
         var _loc2_:IWindow = this.var_17.findChildByTag("SELECTION_BORDER");
         if(_loc2_ != null)
         {
            this.var_1660 = _loc2_.color;
            this.var_189 = _loc2_;
         }
         else
         {
            this.var_189 = this.var_17;
         }
         this.var_189.color = this.var_1326;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_61.code,this.var_764].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_197)
            {
               this.var_189.color = this.var_1660;
            }
         }
