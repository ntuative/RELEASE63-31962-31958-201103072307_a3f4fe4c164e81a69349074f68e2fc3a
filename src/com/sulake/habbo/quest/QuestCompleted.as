package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_209:IFrameWindow;
      ...
      private function onQuestCompletedRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_209.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
      ...
      {
         this.var_209 = IFrameWindow(this.var_61.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_209.findChildByTag("close").procedure = this.onCompletedDialogClose;
         this.var_209.center();
         var _loc2_:IWindow = this.var_209.findChildByName("button.catalog");
         if(_loc2_)
         {
         ...
         this.var_209.caption = "${quest.completed}";
         this.var_209.findChildByName("reward.description").caption = "${" + _loc3_ + ".completed.reward}";
         ...
         this.var_209.findChildByName("description").caption = this.var_61.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_209.findChildByName("reward.currency.desc").caption = this.var_61.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_61.code + "_reward_" + param1.rewardCurrencyAmount;
         var _loc6_:IBitmapWrapperWindow = this.var_209.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
