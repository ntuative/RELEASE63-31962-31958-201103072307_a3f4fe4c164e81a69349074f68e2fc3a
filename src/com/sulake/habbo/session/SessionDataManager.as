package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_2784:Array;
      
      private var var_1590:GroupDetailsView;
      ...
      private var var_560:ProductDataParser;
      ...
      private var var_1592:UserTagManager;
      
      private var var_1293:BadgeImageManager;
      
      private var var_1042:HabboGroupInfoManager;
      
      private var var_846:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2784 = [];
         this.var_1592 = new UserTagManager(events);
         this.var_1042 = new HabboGroupInfoManager(this,events);
         this.var_846 = new IgnoredUsersManager(this);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_286)
         {
            this.var_286.removeEventListener(FurnitureDataParser.const_112,this.onFurnitureReady);
            this.var_286.dispose();
            this.var_286 = null;
         }
         if(this.var_560)
         {
            this.var_560.removeEventListener(ProductDataParser.const_112,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_175 == null || this._localization == null)
         {
            return;
         }
         this.var_1293 = new BadgeImageManager(context.root.assets,events,this.var_175,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1592.communication = this._communication;
         this.var_1042.communication = this._communication;
         this.var_846.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_286)
         {
            ...
            this.var_286 = new FurnitureDataParser(this.var_463,this._wallItems,this.var_464,this._localization);
            this.var_286.addEventListener(FurnitureDataParser.const_112,this.onFurnitureReady);
            if(this.var_175.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_175.getKey("furnidata.load.url");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2142 = _loc2_.clubLevel;
         this.var_1593 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2365 = _loc3_.respectTotal;
         this.var_1044 = _loc3_.respectLeft;
         this._petRespectLeft = _loc3_.petRespectLeft;
         this.var_548 = _loc3_.figure;
         this.var_819 = _loc3_.sex;
         this.var_1716 = _loc3_.realName;
         this.var_846.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_548 = _loc2_.figure;
            this.var_819 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_548,this.var_819));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2141 = _loc2_.isOpen;
         this.var_2140 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1593 >= SecurityLevelEnum.const_1056;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1592.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1293.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1590 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1042.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1590.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1293.getBadgeImage(param1,BadgeImageManager.const_1033);
      }
      ...
      {
         return this.var_846.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_846.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_846.unignoreUser(param1);
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_463.getValue(param1.toString());
      }
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_175.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         {
            _loc2_ = this.var_175.getKey("productdata.load.url");
            this.var_560 = new ProductDataParser(_loc2_,this.var_1152);
            this.var_560.addEventListener(ProductDataParser.const_112,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_847.indexOf(param1) == -1)
            {
               this.var_847.push(param1);
            }
            return null;
         }
         var _loc2_:Array = this.var_463.getValues();
