package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1397:int = 2;
      ...
      private var var_1786:TriggerConfs;
      
      private var var_1787:ActionTypes;
      
      private var var_1788:ConditionTypes;
      
      private var var_256:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_744:RoomObjectHightLighter;
      
      private var var_136:UserDefinedRoomEventsHelp;
      
      private var var_1155:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1786 = new TriggerConfs();
         this.var_1787 = new ActionTypes();
         this.var_1788 = new ConditionTypes();
         this.var_256 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_744 = new RoomObjectHightLighter(param1);
         this.var_136 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_256[param1])
         {
            delete this.var_256[param1];
            this.var_744.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_36.furniLimit)
         {
            this.var_256[param1] = param2;
            this.var_744.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1155 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1155.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1155.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_744.hideAll(this.var_256);
         }
      }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_81.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_36.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_36 as TriggerDefinition != null)
         {
            this.var_81.send(new UpdateTriggerMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ActionDefinition != null)
         {
            this.var_81.send(new UpdateActionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ConditionDefinition != null)
         {
            this.var_81.send(new UpdateConditionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1155.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_136.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1397) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1397 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_81.send(new ApplySnapshotMessageComposer(this.var_36.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1786);
         this.refreshConfigureElement(this.var_1787);
         this.refreshConfigureElement(this.var_1788);
