package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1133:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1725 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1132 = this.var_1725.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1132)
         {
            this.var_1132.procedure = this.onButtonClick;
         }
         this.var_1133 = this.var_1725.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1133)
         {
            this.var_1133.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_252 >= this.var_75.length - 1)
         {
            this.var_1133.disable();
         }
         else
         {
            this.var_1133.enable();
         }
         if(this.var_252 <= 0)
         {
            this.var_1132.disable();
         }
         else
         {
            this.var_1132.enable();
         }
      }
      ...
      {
         ++this.var_252;
         this.var_252 = Math.min(this.var_252,this.var_75.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_75[this.var_252][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_75[this.var_252][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_75[this.var_252][1]).value;
