         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_788:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getNumber(RoomObjectVariableEnum.const_228);
                     _loc6_ = _loc4_.getString(RoomObjectVariableEnum.const_81);
                     ...
                     _loc10_ = new RoomWidgetTrophyDataUpdateEvent(RoomWidgetTrophyDataUpdateEvent.const_901,_loc5_,_loc7_,_loc8_,_loc9_);
