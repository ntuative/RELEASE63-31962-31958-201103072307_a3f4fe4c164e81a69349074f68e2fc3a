package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_395:Map = null;
      
      private var var_285:Map = null;
      
      private var var_559:Map = null;
      
      private var var_1583:Map = null;
      ...
      private var var_687:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_395.length)
            {
               _loc2_ = this.var_395.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_285 != null)
         {
            ...
            {
               _loc2_ = this.var_285.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1038)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_767,RoomWidgetChatSelectAvatarMessage.const_713];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_767:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_41) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1214))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_41) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1214))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_713:
      ...
      {
         return [RoomSessionChatEvent.const_198];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_198:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_179)
                           {
                              _loc13_ = this.var_285.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_395.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_559.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_179:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_559.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_179)
                                    {
                                       this.var_285.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_395.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1039 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1039);
            }
            if(this.var_687 == null)
            {
               ...
               this.var_461.y = 0;
               this.var_461.z = 0;
               this.var_687 = _loc4_.getScreenPoint(this.var_461);
               this.var_1039 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_461.x = 0;
            this.var_461.y = 0;
            this.var_461.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_461);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_687.x || _loc8_.y != this.var_687.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_687,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_285)
         {
            _loc2_ = this.var_285.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_395)
         {
            _loc2_ = this.var_395.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1038.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_559.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1583.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1583.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_285)
            {
               this.var_285.add(_loc3_,param2);
            }
         }
      }
   }
