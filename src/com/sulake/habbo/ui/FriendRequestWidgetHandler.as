package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_871);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_639);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_851);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_871:
            ...
            case RoomWidgetFriendRequestMessage.const_639:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_851:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_47);
         _loc1_.push(FriendRequestEvent.const_318);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_149:
               ...
               break;
            case FriendRequestEvent.const_47:
            case FriendRequestEvent.const_318:
