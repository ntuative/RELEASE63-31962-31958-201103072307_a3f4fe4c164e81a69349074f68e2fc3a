package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_796,RoomWidgetEcotronBoxOpenMessage.const_853,RoomWidgetEcotronBoxOpenedMessage.const_1601];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_796:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_853:
