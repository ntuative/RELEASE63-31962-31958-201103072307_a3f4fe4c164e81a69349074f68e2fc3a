package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1159:IRoomWidgetFactory;
      ...
      private var var_1902:IHabboAvatarEditor = null;
      ...
      private var var_1099:IHabboHelp;
      
      private var var_957:IHabboModeration;
      ...
      {
         this.var_1466 = RoomDesktop.const_470;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1159.release(new IIDHabboRoomWidget());
            this.var_1159 = null;
         }
         ...
         {
            this.var_1099.release(new IIDHabboHelp());
            this.var_1099 = null;
         }
         ...
         {
            this.var_957.release(new IIDHabboModeration());
            this.var_957 = null;
         }
         ...
         if(this.var_314)
         {
            while(this.var_314.length > 0)
            {
               _loc1_ = this.var_314.getKey(0) as String;
               _loc2_ = this.var_314.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1159 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1902 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_315 != null && this.var_315.events != null)
         {
            this.var_315.events.addEventListener(AdEvent.const_442,this.adEventHandler);
            this.var_315.events.addEventListener(AdEvent.const_503,this.adEventHandler);
            this.var_315.events.addEventListener(AdEvent.const_553,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1099 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_957 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_957);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_252,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_198,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_569,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_459,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_533,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_435,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1102,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_624,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_467,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_155,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_150,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_131,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_448,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_149,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_124,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionWelcomeGiftEvent.const_111,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               if(param1.session != null)
               {
                  ...
                  this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.ZOOM));
                  this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.MEMENU));
                  this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_820:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_624:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_842,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_809,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_661,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_527,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_485,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_62,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_715,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_291,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_827,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_842)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_485 || param1.type == RoomEngineEvent.const_527)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_809:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_705);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_707);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_372);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1466 != RoomDesktop.const_470)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_309,this.var_1466);
               }
               if(this.var_315 != null)
               {
                  this.var_315.showRoomAd();
               }
               break;
            case RoomEngineEvent.const_661:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_715:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1159;
         _loc3_.sessionDataManager = this.var_299;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_516;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_171;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1902;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_315;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1099;
         _loc3_.moderation = this.var_957;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_600;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_686);
         _loc3_.init();
         this.var_314.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_314.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_309);
            if(_loc3_ != RoomDesktop.const_470)
            {
      ...
      {
         return this.var_314.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_314.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
