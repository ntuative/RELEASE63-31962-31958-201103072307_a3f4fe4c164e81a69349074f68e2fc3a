   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_157,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_156,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_157,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_156,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_563.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_563.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_373);
         _loc1_.push(RoomWidgetUserActionMessage.const_879);
         _loc1_.push(RoomWidgetUserActionMessage.const_618);
         _loc1_.push(RoomWidgetUserActionMessage.const_803);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_876);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_648);
         _loc1_.push(RoomWidgetFurniActionMessage.const_839);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_693);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_903);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_812);
         _loc1_.push(RoomWidgetUserActionMessage.const_484);
         _loc1_.push(RoomWidgetUserActionMessage.const_866);
         _loc1_.push(RoomWidgetUserActionMessage.const_524);
         _loc1_.push(RoomWidgetUserActionMessage.const_1412);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_341);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_484)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_341 || param1.type == RoomWidgetUserActionMessage.const_574 || param1.type == RoomWidgetUserActionMessage.const_524)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_373:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_879:
            ...
            case RoomWidgetUserActionMessage.const_574:
               ...
               break;
            case RoomWidgetUserActionMessage.const_803:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1069,_loc3_.name);
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_648:
            ...
            case RoomWidgetRoomTagSearchMessage.const_693:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_903:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_812:
               ...
               break;
            case RoomWidgetUserActionMessage.const_484:
               this._container.roomSession.kickBot(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_866:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_289);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1028);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1226);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_172)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_679)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_570);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_120)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_141)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_663);
                     _loc13_.hasFlatControl = _loc31_ == "onlyfurniture" || _loc31_ == "useradmin" || _loc31_ == "";
                     _loc13_.method_2 = this._container.roomSession.isPrivateRoom;
                  }
                  ...
                  _loc27_ = !this._container.sessionDataManager.method_7;
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_996;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1082;
                  }
               ...
               {
                  _loc13_.method_2 = this._container.roomSession.isRoomOwner;
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1570);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_70,RoomSessionUserGivableBadgesEvent.const_70];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_70:
               ...
               break;
            case RoomSessionUserGivableBadgesEvent.const_70:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_563.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_563.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
