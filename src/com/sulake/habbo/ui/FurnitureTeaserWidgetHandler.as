package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_674,RoomWidgetViralFurniMessage.const_891,RoomWidgetViralFurniMessage.const_160];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_674:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_490);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_891:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendViralFurniFoundMessage();
               }
               break;
            case RoomWidgetViralFurniMessage.const_160:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_533,RoomSessionViralFurniStatusEvent.const_435];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_533:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_757);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_435:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
