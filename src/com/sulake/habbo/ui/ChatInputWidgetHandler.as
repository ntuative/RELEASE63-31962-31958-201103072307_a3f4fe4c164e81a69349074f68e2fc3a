package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_805);
         _loc1_.push(RoomWidgetChatTypingMessage.const_850);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_805:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_850:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1003,HabboToolbarIconEnum.CHATINPUT,param1));
      ...
      {
         return [RoomSessionChatEvent.const_571];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_571:
