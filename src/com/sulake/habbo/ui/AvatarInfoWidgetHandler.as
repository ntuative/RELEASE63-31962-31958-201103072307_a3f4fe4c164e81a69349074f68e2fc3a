package com.sulake.habbo.ui
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_671);
         _loc1_.push(RoomWidgetUserActionMessage.const_732);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_671:
               this.dispatchOwnAvatarInfo();
               break;
            case RoomWidgetUserActionMessage.const_732:
