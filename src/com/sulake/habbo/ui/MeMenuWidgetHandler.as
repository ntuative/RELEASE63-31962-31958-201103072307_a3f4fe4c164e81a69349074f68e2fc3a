   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_288,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_701,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_749,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_171 != null)
            {
               this.var_171.events.removeEventListener(HabboToolbarEvent.const_64,this.onHabboToolbarEvent);
               this.var_171.events.removeEventListener(HabboToolbarEvent.const_36,this.onHabboToolbarEvent);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_504,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_288,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_701,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_749,this.onHabboClubSubscriptionChanged);
         }
         this.var_171 = this._container.toolbar;
         if(this.var_171 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_504,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1416)
            {
               ...
               this.var_1416 = _loc2_;
               this.var_1834 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1834;
            }
         }
         if(this.var_171 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1142,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_171.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_716);
         _loc1_.push(RoomWidgetDanceMessage.const_846);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_884);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_734);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_833);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_706);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_736);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_387);
         _loc1_.push(RoomWidgetStopEffectMessage.const_763);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1576);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1100);
         _loc1_.push(RoomWidgetToolbarMessage.const_837);
         _loc1_.push(RoomWidgetToolbarMessage.const_819);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_385);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1608);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1219);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_782);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_907);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_719);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1507);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_628);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_739);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_670);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_358);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_907:
               ...
               break;
            case RoomWidgetWaveMessage.const_716:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_846:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_884:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_734:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_833:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_387:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1143)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_736:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1124:
                        this._catalog.openCatalogPage(CatalogPageName.const_1585,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1108:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_302);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1639:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1645:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_706:
            case RoomWidgetStopEffectMessage.const_763:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1100:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_782:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_837:
               ...
               if(this.var_171)
               {
                  this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_819:
               _loc6_ = param1 as RoomWidgetToolbarMessage;
               if(!_loc6_)
               {
                  return null;
               }
               if(this.var_171 && this.var_171.events)
               {
                  this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_453,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_385:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_576));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_719:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_384,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_628:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_384,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_739:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_384,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_670:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_580));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_358:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_862));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_838));
      }
