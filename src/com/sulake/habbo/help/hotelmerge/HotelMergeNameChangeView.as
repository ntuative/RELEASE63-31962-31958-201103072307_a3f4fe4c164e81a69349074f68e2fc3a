package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_689)
         {
            this.var_689 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_689)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_688)
         {
            this.var_688 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_688)
            {
               return;
            }
