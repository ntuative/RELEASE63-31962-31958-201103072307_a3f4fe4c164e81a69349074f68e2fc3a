package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_351 = this._defaultViewId;
         this.var_485 = new Array();
         this.var_602 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103072302));
         this.var_171 = param5;
         this.var_114 = new Map();
         this.var_114.add(HabboHelpViewEnum.const_1511,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_188,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_440,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_321,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_250,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_344,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_653,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_235,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_114.add(HabboHelpViewEnum.const_1135,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_114.add(HabboHelpViewEnum.const_1157,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_817,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_114.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_114.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_485.length == 0 || param1 != this.var_351)
            {
               this.var_485.push(this.var_351);
            }
         }
         this.var_351 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_351);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_235:
               this.showUI(HabboHelpViewEnum.const_235);
               break;
            case CallForHelpResultEnum.const_992:
               this.showUI(HabboHelpViewEnum.const_1157);
               break;
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_114.getValue(HabboHelpViewEnum.const_188) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_480));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_114.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_114.getValue(this.var_351);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2432 = this._window.width - _loc4_.width;
         this.var_2433 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2433;
         this._window.width = _loc1_.width + this.var_2432;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_485.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_351 == HabboHelpViewEnum.const_188)
         {
            return;
         }
         if(this.var_602.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_602.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_602[1],this.var_602[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_602[0],this.var_602[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_351 == HabboHelpViewEnum.const_188 || this.var_485.length == 0)
         {
            return;
         }
         if(this.var_350 == null)
         {
            ...
            this.var_350 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_350.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_350.findChildByName("back_text");
            if(_loc5_ != null)
            {
