package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_364:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_354:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_480,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
         ...
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_288,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1139 && this.var_1140 && this.var_1382;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_480,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_580,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_288,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_43 == null || this.var_43.id == const_92)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_480:
               this.var_1382 = true;
               if(this.var_43 != null && this.var_43.id == const_428)
               {
                  this.showView(const_92);
               }
               break;
            case HabboHelpTutorialEvent.const_576:
               if(this.var_43 != null && this.var_43.id == const_364)
               {
                  this.var_1747 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2432 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_317:
               ...
               if(this.var_354 == null)
               {
                  this.var_354 = new NameChangeView(this);
               }
               this.var_354.showMainView();
               this.prepareForTutorial();
               break;
            case const_364:
         ...
         this._window.height = _loc2_.height + this.var_2433;
         this._window.width = _loc2_.width + this.var_2432;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_317 || this.var_43.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      {
         this.var_1139 = true;
         if(this.var_43 != null && (this.var_43.id == const_364 || this.var_43.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_530)
         {
            this.var_1140 = true;
         ...
         {
            this.var_354.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_530)
         {
            this.var_354.checkedName = _loc2_.name;
         }
         else
         {
            this.var_354.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
