package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1291:uint = 13232628;
      
      private static var var_1585:uint = 11129827;
      ...
      private var var_1587:IWindowContainer;
      ...
      private var var_1041:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_317;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_462 = param1;
         if(this.var_1586 == this.var_462)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1587 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_689)
         {
            this.var_689 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_689)
            {
               return;
            }
            this._window.content.addChild(this.var_689);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_688)
         {
            this.var_688 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_688)
            {
               return;
            }
            this._window.content.addChild(this.var_688);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_688.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_462;
         }
         this.showView(this.var_688);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_462);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_797:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_990 || param1 == ChangeUserNameResultMessageEvent.var_989)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1041 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1041.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1291;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_462 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_462 != _loc5_)
               {
                  this.var_1586 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_462);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_92);
         }
      }
