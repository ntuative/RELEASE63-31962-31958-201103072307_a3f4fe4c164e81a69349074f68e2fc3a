package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_809:int = 0;
      
      protected var var_658:BitmapData;
      
      protected var var_2070:int;
      
      protected var var_1504:Boolean;
      
      protected var var_2012:Boolean;
      
      protected var var_2776:BitmapData;
      
      private const const_1984:int = 8947848;
      
      private const const_1985:int = 13421772;
      
      private const const_1724:Number = 1;
      
      private const const_1723:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this._mainCategory == FurniModel.const_43)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1385));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1993);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_844)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1723;
               _loc1_.blend = this.const_1723;
            }
            else
            {
               this._window.blend = this.const_1724;
               _loc1_.blend = this.const_1724;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2012 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2776;
               _loc5_.visible = true;
            }
            else
            {
