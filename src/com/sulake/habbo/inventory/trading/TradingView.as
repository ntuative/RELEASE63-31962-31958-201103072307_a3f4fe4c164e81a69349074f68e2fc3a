package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_942:uint = 2577770;
      ...
      private var var_415:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_415 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_194)
            {
               this.var_194.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_194.stop();
               this.var_194 = null;
            }
      ...
      public function setup(param1:int, param2:Boolean, param3:int, param4:Boolean) : void
      {
         ...
         else
         {
            ...
            if(!param4)
            {
               this.method_4("${inventory.trading.warning.others_account_disabled}");
            }
         }
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1707 = this.createMinimizedWindow();
         }
         if(!this.var_2385)
         {
            return this.var_71;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_71)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_941) : uint(const_942);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_941) : uint(const_942);
            }
         ...
         if(this.var_71)
         {
            ...
            switch(this.var_21.state)
            {
               ...
               case TradingModel.const_366:
                  ...
                  break;
               case TradingModel.const_278:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_568:
                  _loc1_.disable();
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_194 = new Timer(1000,3);
            this.var_194.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_194.reset();
         this.var_194.repeatCount = 3;
         this.var_194.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_194.currentCount));
         if(this.var_194.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_162)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1156)
            {
            ...
            this.var_415.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_427);
            this.var_415.show();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_415.hideDelayed();
         }
      }
