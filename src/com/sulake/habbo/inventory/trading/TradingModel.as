package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1449:uint = 9;
      
      public static const const_202:uint = 0;
      
      public static const const_187:uint = 1;
      
      public static const const_366:uint = 2;
      
      public static const const_278:uint = 3;
      
      public static const const_568:uint = 4;
      
      public static const const_224:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_54.updateItemList(this.var_663);
         this.var_54.updateItemList(this.var_1268);
      ...
      public function close() : void
      {
         if(this.var_706)
         {
            if(this._state != const_202 && this._state != const_224)
            {
      ...
      {
         this.var_54.setMinimized(param1 != InventoryCategory.const_78);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_664 + " OTHER: " + this.var_1006);
         ...
         {
            case const_202:
               if(param1 == const_187 || param1 == const_224)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_234.length)
         {
            _loc2_ = this.var_234.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         if(this._state == const_366)
         {
            this.state = const_278;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_54.alertPopup(TradingView.const_1198);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1006 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_54.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_54.alertPopup(TradingView.const_1046);
            }
            this.close();
         }
         ...
         {
            this.var_54.method_4("${inventory.trading.warning.others_account_disabled}");
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_234.length < const_1449)
         {
         ...
         else
         {
            ...
            if(this.var_234.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
