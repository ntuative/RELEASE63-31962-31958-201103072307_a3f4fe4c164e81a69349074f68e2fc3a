package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1611:IWindowContainer;
      
      private var var_695:String;
      
      private var var_2785:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_171 != null && this.var_1057)
         {
            this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1057 = false;
         }
         this._controller.inventoryViewOpened(this.var_695);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_696 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_171 != null && this.var_1057)
            {
               this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1057 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_695);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1611);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_696 == InventoryCategory.const_134)
            {
               this.toggleCategoryView(InventoryCategory.const_134);
            }
            else if(this.var_696 == InventoryCategory.const_78)
            {
