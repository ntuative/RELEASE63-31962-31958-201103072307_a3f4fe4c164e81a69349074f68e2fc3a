package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_299 = param5;
         this.var_299.events.addEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImageReady);
         this.var_17 = new BadgesView(this,param2,param4);
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_886[_loc2_] == param1)
            {
               this.var_886.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_299.getBadgeImage(param1);
      ...
      {
         if(param1 == InventoryCategory.const_302 && this._controller.isVisible)
         {
