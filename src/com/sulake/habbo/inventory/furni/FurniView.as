package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2022:int = 0;
      
      private const const_969:int = 1;
      
      private const const_1696:int = 2;
      
      private const const_1695:int = 3;
      
      private const const_1694:int = 42;
      
      private const const_1697:int = 120;
      ...
      private var var_667:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_414.add(FurniModel.const_43,new FurniGridView(this.var_67,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_414.add(FurniModel.const_49,new FurniGridView(this.var_67,FurniModel.const_49,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.var_17 = IWindowContainer(this._windowManager.buildFromXML(XML(_loc7_.content)));
         this.var_17.visible = false;
         this.var_17.procedure = this.windowEventProc;
         this.switchCategory(FurniModel.const_43);
         var _loc8_:IWindowContainer = this.var_17.findChildByName("preview_container") as IWindowContainer;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_17.findChildByName("download_image") as IBitmapWrapperWindow;
         ...
         _loc9_ = this.var_17.findChildByName("image") as IBitmapWrapperWindow;
         _loc9_.bitmap = new BitmapData(_loc9_.width,_loc9_.height);
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_414.getValue(this.var_413);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_67.getCategoryContent(this.var_413);
         if(!this.var_67.isListInited())
         {
            _loc2_ = this.const_969;
         }
         ...
         if(this.var_2376 == _loc2_)
         {
            return;
         }
         this.var_2376 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_43,FurniModel.const_49];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_67.getGroupItemInIndex(_loc3_,this.var_413);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_375)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_352)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_667 && this.var_667.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1697)
         {
            _loc3_ = this.const_1697;
         }
         else if(_loc3_ < this.const_1694)
         {
            _loc3_ = this.const_1694;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_60)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_333);
            }
         }
      }
   }
