package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_43:String = "S";
      
      public static const const_49:String = "I";
      
      public static const const_333:String = "pets";
      ...
      private var var_1817:Vector.<Array>;
      
      private var var_1818:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_246,this.onObjectPlaced);
         this._catalog = param7;
         this.var_619 = new Timer(const_1337,1);
         this.var_619.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2550 = XML(_loc9_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine);
         this.var_17.switchCategory(const_43);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_246,this.onObjectPlaced);
               }
            ...
            {
               this.var_619.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_619.stop();
               this.var_619 = null;
            }
            if(this.var_200 != null)
            {
               this.var_200.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_200.stop();
               this.var_200 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_43)
            {
               ...
               {
                  this.var_1817 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1817;
            }
            else
            {
               if(this.var_1818 == null)
               {
                  this.var_1818 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1818;
            }
         ...
         this.var_17.setGridLock(param1,true);
         ...
         this.var_17.setGridLock(param1,false);
         this.updateItemLocks();
         if(this.getSelectedItemIndex(FurniModel.const_43) == -1)
         {
            this.toggleItemSelection(FurniModel.const_43,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_375)
         {
         ...
         else if(param3 == FurniCategory.const_352)
         {
         ...
         if(this.var_927 == null)
         {
            this.var_927 = this._windowManager.buildFromXML(this.var_2550) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_927.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_43,const_49];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_200 = new Timer(param1,1);
            this.var_200.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_200.start();
         }
         else
         {
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            switch(this.var_17.visibleCategoryId)
            {
               case const_43:
               ...
               case const_49:
                  ...
                  break;
               case const_333:
                  this._controller.toggleInventoryPage(InventoryCategory.const_134);
            }
         }
      }
      ...
      {
         this.var_17.switchCategory(param1);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_370);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_43,const_49];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_43,const_49];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_620.add(const_43,new Array());
         this.var_620.add(const_49,new Array());
         if(this.var_17 != null)
         {
            this.var_17.clearViews();
         }
      }
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         if(!param1.groupable)
         {
            ...
            if(this.var_17 != null)
            {
               if(param3 == -1)
               {
                  this.var_17.addItemToBottom(_loc4_,_loc5_);
               }
               else
               {
                  this.var_17.addItemAt(_loc4_,_loc5_,param3);
               }
            }
         }
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_162)
                  {
                     _loc5_ = _loc7_;
                  }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc7_ < _loc2_.length)
               {
                  ...
                  if(_loc8_)
                  {
                     ...
                     {
                        this.var_17.removeItem(_loc3_,_loc7_);
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         ...
         if(_loc3_.length > param2)
         {
            ...
            this.var_17.updateItem(param1,_loc4_,param2);
         }
      ...
      {
         if(this.var_17 && !this.var_17.disposed)
         {
            this.var_17.displayItemInfo(param1);
         }
      }
      ...
      public function getSelectedItemIndex(param1:String = null) : int
      {
         ...
         if(param1 == null)
         {
            param1 = this.var_17.visibleCategoryId;
         }
      ...
      public function getGroupItemInIndex(param1:int, param2:String = null) : GroupItem
      {
         if(param2 == null)
         {
            param2 = this.var_17.visibleCategoryId;
         }
      ...
      {
         var _loc2_:GroupItem = this.getGroupItemInIndex(this.getSelectedItemIndex(),this.var_17.visibleCategoryId);
         if(_loc2_ == null)
         {
            return false;
         }
         ...
         if(_loc3_.category == FurniCategory.const_352 || _loc3_.category == FurniCategory.const_375 || _loc3_.category == FurniCategory.const_368)
         {
            if(param1)
            {
               return false;
      ...
      {
         var _loc1_:GroupItem = this.getGroupItemInIndex(this.getSelectedItemIndex(),this.var_17.visibleCategoryId);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_1409 && param1.type == RoomEngineObjectEvent.const_246)
         {
            this.var_1409 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_620.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_844)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
