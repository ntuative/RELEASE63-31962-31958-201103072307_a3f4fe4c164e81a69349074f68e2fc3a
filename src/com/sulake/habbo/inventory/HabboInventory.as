package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1064:IRoomSession;
      ...
      private const const_1990:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_425,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_50.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_50.getValue(InventorySubCategory.const_305));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_787));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_302));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_350));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_50.getValue(InventoryCategory.const_134));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_50.getValue(InventoryCategory.const_370) as MarketplaceModel;
      }
      ...
      {
         return this.var_99.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_99.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_99.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_99.clubHasEverBeenMember;
      }
      ...
      {
         this.var_99.clubPeriods = param1;
         this.var_99.clubDays = param2;
         this.var_99.clubHasEverBeenMember = param3;
         this.var_99.isVIP = param4;
      ...
      {
         this.var_299 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_425,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               this.var_1064 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_425:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_299 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_171)
         {
            return;
         }
         this.var_17 = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this.var_17.setToolbar(this.var_171);
         this.var_50 = new Map();
         ...
         this.var_50.add(InventoryCategory.const_370,_loc1_);
         ...
         this.var_50.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_299);
         this.var_50.add(InventoryCategory.const_302,_loc3_);
         ...
         this.var_50.add(InventoryCategory.const_787,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_299);
         this.var_50.add(InventoryCategory.const_350,_loc5_);
         ...
         this.var_50.add(InventorySubCategory.const_305,_loc6_);
         ...
         this.var_50.add(InventoryCategory.const_134,_loc8_);
         this.var_184 = true;
         if(this.var_2207)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_305:
               this.var_17.toggleCategoryView(InventoryCategory.const_78,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_857.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_857.splice(_loc3_,1);
            }
         }
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1990);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_701));
      }
