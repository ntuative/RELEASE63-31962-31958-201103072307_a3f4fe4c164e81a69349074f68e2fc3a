package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_67:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_248:IItemGridWindow;
      ...
      private var var_367:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_248 = this.var_17.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_367);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_633.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_248.removeGridItem(_loc2_.window);
         if(this.var_367 == _loc2_)
         {
            this.var_367 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_633 == null || this.var_633.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_633.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_633.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_248.addGridItem(_loc2_.window);
            this.var_633.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_248.removeGridItems();
         this.var_633.reset();
         var _loc1_:Map = this.var_67.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_367.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_67.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_60)
         {
            ...
            {
               case "tab_floor":
                  this.var_67.switchCategory(FurniModel.const_43);
                  break;
               case "tab_wall":
                  this.var_67.switchCategory(FurniModel.const_49);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_367 != null)
         {
            this.var_367.setSelected(false);
         }
         this.var_367 = param1;
         if(this.var_367 != null)
         {
            this.var_367.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_67.roomSession != null)
         {
            _loc8_ = this.var_67.roomSession.arePetsAllowed;
            _loc9_ = this.var_67.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
