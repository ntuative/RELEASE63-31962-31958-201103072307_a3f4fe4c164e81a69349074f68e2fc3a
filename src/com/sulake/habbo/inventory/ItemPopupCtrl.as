package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_956:int = 5;
      
      private static const const_1333:int = 250;
      
      private static const const_1334:int = 100;
      ...
      {
         this.var_363 = new Timer(const_1333,1);
         this.var_362 = new Timer(const_1334,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this._assets = param2;
         this.var_363.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_362.addEventListener(TimerEvent.TIMER,this.onHideTimer);
         var _loc3_:BitmapDataAsset = this._assets.getAssetByName("popup_arrow_right_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_926 = _loc3_.content as BitmapData;
         }
         _loc3_ = this._assets.getAssetByName("popup_arrow_left_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_753 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_363.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_363.stop();
            this.var_363 = null;
         }
         if(this.var_362 != null)
         {
            this.var_362.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_362.stop();
            this.var_362 = null;
         }
         this._assets = null;
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1816);
         switch(this.var_1816)
         {
            case const_1210:
               this.var_82.x = -1 * this.var_82.width - const_956;
               break;
            case const_427:
               this.var_82.x = this._parent.width + const_956;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1210:
               _loc2_.bitmap = this.var_926.clone();
               _loc2_.width = this.var_926.width;
               _loc2_.height = this.var_926.height;
               _loc2_.y = (this.var_82.height - this.var_926.height) / 2;
               _loc2_.x = this.var_82.width - 1;
               break;
            case const_427:
               _loc2_.bitmap = this.var_753.clone();
               _loc2_.width = this.var_753.width;
               _loc2_.height = this.var_753.height;
               _loc2_.y = (this.var_82.height - this.var_753.height) / 2;
               _loc2_.x = -1 * this.var_753.width + 1;
         }
         _loc2_.invalidate();
      }
