package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_67:MarketplaceModel;
      ...
      public function showBuyTokens(param1:int, param2:int) : void
      {
         ...
         this.var_17 = this.createWindow("buy_marketplace_tokens_xml") as IFrameWindow;
         if(this.var_17 == null)
         {
            return;
         }
         this.var_17.procedure = this.clickHandler;
         this.var_17.center();
      }
      ...
      {
         var _loc4_:* = null;
         if(!param1 || !this._localization || !this._roomEngine || !this.var_67)
         {
            return;
         }
         this.var_17 = this.createWindow("make_marketplace_offer_xml") as IFrameWindow;
         if(!this.var_17)
         {
            return;
         }
         var _loc2_:ITextFieldWindow = this.var_17.findChildByName("price_input") as ITextFieldWindow;
         if(_loc2_ != null)
         {
            _loc2_.restrict = "0-9";
         }
         this.checkPrice();
         this._localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",this.var_67.expirationHours.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",this.var_67.offerMinPrice.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",this.var_67.offerMaxPrice.toString());
         ...
         this.var_2660 = this._localization.getKey(_loc5_);
         this.setText("furni_name","${" + _loc5_ + "}");
         this.setText("furni_desc","${" + _loc6_ + "}");
         this.var_17.procedure = this.clickHandler;
         this.var_17.center();
         var _loc7_:ITextWindow = this.var_17.findChildByName("average_price") as ITextWindow;
         if(_loc7_)
         {
            _loc7_.visible = false;
         }
         this.var_67.getItemStats();
      }
      
      private function setFurniImage(param1:BitmapData) : void
      {
         if(param1 == null || this.var_17 == null)
         {
            return;
         }
         var _loc2_:IBitmapWrapperWindow = this.var_17.findChildByName("furni_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function setText(param1:String, param2:String) : void
      {
         ...
         var _loc3_:ITextWindow = this.var_17.findChildByName(param1) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function showNoCredits(param1:int) : void
      {
         ...
         this.var_17 = this.createWindow("marketplace_no_credits_xml") as IFrameWindow;
         if(this.var_17 == null)
         {
            return;
         }
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2660);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_1890.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_67.makeOffer(this.var_1890);
         }
         this.var_67.releaseItem();
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "buy_tokens_button":
                  this.var_67.buyMarketplaceTokens();
                  this.disposeView();
                  break;
               ...
               case "make_offer_button":
                  _loc3_ = this.var_17.findChildByName("price_input") as ITextFieldWindow;
                  if(_loc3_ != null)
                  {
                     this.var_1890 = parseInt(_loc3_.text);
      ...
      private function checkPrice() : void
      {
         ...
         var _loc1_:ITextFieldWindow = this.var_17.findChildByName("price_input") as ITextFieldWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:int = parseInt(_loc1_.text);
         if(_loc2_ > this.var_67.offerMaxPrice)
         {
            _loc1_.text = this.var_67.offerMaxPrice.toString();
            _loc2_ = this.var_67.offerMaxPrice;
         }
         var _loc3_:int = Math.max(Math.ceil(this.var_67.commission * 0.01 * _loc2_),1);
         var _loc4_:int = _loc2_ + _loc3_;
         var _loc5_:IButtonWindow = this.var_17.findChildByName("make_offer_button") as IButtonWindow;
         var _loc6_:ITextWindow = this.var_17.findChildByName("final_price") as ITextWindow;
         ...
         if(_loc2_ < this.var_67.offerMinPrice)
         {
      ...
      {
         if(!this.var_17 || !this._localization || !this.var_67)
         {
            return;
         }
         var _loc3_:ITextWindow = this.var_17.findChildByName("average_price") as ITextWindow;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:int = Math.floor(param1 / (1 + this.var_67.commission * 0.01));
