package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1222:IDropMenuWindow;
      ...
      private var var_982:OffenceCategoryData;
      
      private var var_981:OffenceData;
      
      private var var_1221:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1221 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1220 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1535;
         ...
         this.var_1222 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1222);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_982 != null;
         if(this.var_981 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_981.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_982 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_982.offences,this.var_1221,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1220,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1489,this.var_521.text,this.var_1488));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_982 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_981 = this.var_982.offences[_loc3_];
         this.var_521.text = this.var_981.msg;
         this.var_625 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1489,this.var_521.text,this.var_1488));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1222.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1489,this.var_521.text,this.getBanLength(),this.var_1488));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1222.selection;
