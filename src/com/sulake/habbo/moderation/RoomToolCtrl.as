package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_894:ICheckBoxWindow;
      
      private var var_1375:ICheckBoxWindow;
      
      private var var_1376:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_33.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_328));
         Logger.log("BEGINNING TO SHOW: " + this.var_328);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1519;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_328);
         if(param1.flatId != this.var_328)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_328);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_894 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1375 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1376 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_762,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_894.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1659,_loc2_,this.var_521.text,"",""));
         if(this.var_1375.isSelected || this.var_1376.isSelected || this.var_894.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1375.isSelected,this.var_1376.isSelected,this.var_894.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1514);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1403);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1010.selection];
         if(_loc3_ != null)
         {
            this.var_625 = false;
