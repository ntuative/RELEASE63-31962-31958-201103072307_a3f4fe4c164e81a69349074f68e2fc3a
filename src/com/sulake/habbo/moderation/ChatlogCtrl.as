package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_954:Array = [];
      
      private static var var_1900:int = 1000;
      
      private static var var_953:Array = [];
      
      private static var var_1898:int = 200;
      ...
      private var var_1897:IMessageComposer;
      ...
      private var var_1899:Dictionary;
      ...
      public function show() : void
      {
         ...
         this.var_33.connection.send(this.var_1897);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_954.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_953.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1899[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1464.getValue(param2.chatterName))
            {
               this.var_1464.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1464.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1463)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1465)
         {
