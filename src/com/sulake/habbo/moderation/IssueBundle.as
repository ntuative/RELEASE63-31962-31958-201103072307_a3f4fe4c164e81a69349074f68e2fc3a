package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_729:IssueMessageData = null;
      
      private var var_730:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2398 = param2.pickerUserId;
         this.var_2421 = param2.pickerUserName;
         this.var_1373 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1129 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1128;
         }
         if(this.var_729 == null || param1.timeStamp < this.var_729.timeStamp)
         {
            this.var_729 = param1;
         }
         if(this.var_730 == null || param1.priority > this.var_730.timeStamp)
         {
            this.var_730 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1129 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1128;
            }
            if(this.var_729 == _loc2_)
            {
               this.var_729 = null;
            }
            if(this.var_730 == _loc2_)
            {
               this.var_730 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_730;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_729;
         if(_loc2_ == null)
         {
