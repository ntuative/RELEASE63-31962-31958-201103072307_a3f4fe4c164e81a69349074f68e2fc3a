package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1062:String = "issue_bundle_open";
      
      public static const const_692:String = "issue_bundle_my";
      
      public static const const_1147:String = "issue_bundle_picked";
      
      public static const const_1591:int = 15000;
       
      
      private var var_64:ModerationManager;
      
      private var var_644:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_644 = new IssueBrowser(this,this.var_64.windowManager,this.var_64.assets);
         this.var_1209 = [];
         this.var_1208 = [];
         this.var_970 = new Map();
         this.var_2697 = parseInt(this.var_64.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1916 = new Timer(const_1591,0);
         this.var_1916.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1916.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1209 = this.var_1209.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_161 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_345 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1208 = this.var_1208.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_644 == null || !this.var_644.isOpen())
         {
            this.var_64.soundManager.playSound(HabboSoundTypesEnum.const_1047);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1657)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1209.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_64.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_345)
               {
                  this.unhandleBundle(_loc3_.id);
               }
            }
         }
         if(param1.state == IssueMessageData.const_161)
         {
            _loc6_ = this.getBundles(const_692);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1208.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2697);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_970.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_970.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_104)
         {
            ...
            {
               case const_1062:
                  if(_loc4_.state == IssueMessageData.const_161)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_692:
                  if(_loc4_.state == IssueMessageData.const_345 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_970.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_970.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_345 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_970.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
