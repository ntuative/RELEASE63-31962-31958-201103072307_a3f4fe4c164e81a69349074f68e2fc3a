package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_153:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_479:UserInfoCtrl;
      
      private var var_1102:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_50,this.onResized);
         }
         ...
         var _loc3_:IssueMessageData = this.var_153.getHighestPriorityIssue();
         this.var_479 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1102 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_479.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_153.reportedUserId > 0)
         {
            this.var_1102.load(_loc4_,this.var_153.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_153.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_153.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_64 != null && this.var_64.issueManager != null && this.var_153 != null)
         {
            this.var_64.issueManager.removeHandler(this.var_153.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_153.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_153.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_153.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.releaseBundle(this.var_153.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_153.getHighestPriorityIssue().issueId;
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1070,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_153.getHighestPriorityIssue();
            this.var_479 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
            this.var_479.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
