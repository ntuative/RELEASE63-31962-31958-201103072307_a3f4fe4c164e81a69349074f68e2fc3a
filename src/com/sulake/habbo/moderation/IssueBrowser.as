package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1993:String = "my_issues";
      
      private const const_1994:String = "open_issues";
      
      private const const_1995:String = "picked_issues";
      
      private const const_2021:String = "closed_issues";
      ...
      private var var_1664:IIssueBrowserView;
      
      private var var_1663:IIssueBrowserView;
      
      private var var_1665:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_245 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_245.numTabItems)
            {
               _loc5_ = this.var_245.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_60,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_245 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_245 == null || this.var_245.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_245.selector.getSelectableByName("open_issues");
         this.var_245.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_341.view.width = this.var_245.container.width;
         this.var_341.view.height = this.var_245.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1993:
               ...
               {
                  this.var_1664 = new MyIssuesView(this.issueManager,this,this.var_245.container);
               }
               return this.var_1664;
            case this.const_1994:
               if(this.var_1663 == null)
               {
                  this.var_1663 = new OpenIssuesView(this.issueManager,this,this.var_245.container);
               }
               return this.var_1663;
            case this.const_1995:
               if(this.var_1665 == null)
               {
                  this.var_1665 = new PickedIssuesView(this.issueManager,this,this.var_245.container);
               }
