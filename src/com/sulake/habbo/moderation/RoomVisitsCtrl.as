package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_940:Array = [];
      
      private static var var_1866:int = 200;
      ...
      {
         this.var_769 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1513;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_940.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_769.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_940.length < var_1866)
         {
            ...
            param1.width = this.var_769.width;
            param1.height = this.var_769.height;
            var_940.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1440)
         {
