package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_598:String = "tab_boy";
      
      private const const_597:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_67.controller.gender)
         {
            case FigureData.const_74:
               activateTab(this.const_598);
               inactivateTab(this.const_597);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_597);
               inactivateTab(this.const_598);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_598:
                  var_67.controller.gender = FigureData.const_74;
