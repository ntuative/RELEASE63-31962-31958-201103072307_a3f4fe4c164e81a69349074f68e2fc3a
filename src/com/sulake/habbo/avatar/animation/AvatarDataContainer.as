package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1805:Number = 1.0;
      ...
      {
         super();
         this.var_1879 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2632 = parseInt(_loc2_,16);
         this.var_2633 = parseInt(_loc3_,16);
         ...
         this.var_1941 = new ColorTransform(this.var_1805,this.var_1802,this.var_1804,this._alphaMultiplier);
         this.var_1190 = this.generatePaletteMapForGrayscale(this.var_2633,this.var_2632);
      }
