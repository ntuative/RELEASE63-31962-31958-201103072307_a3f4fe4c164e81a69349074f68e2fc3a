package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_392:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_945:AvatarActionManager;
      
      private var var_373:FigureData;
      
      private var var_433:PartSetsData;
      
      private var var_280:AnimationData;
      
      private var var_777:AnimationManager;
      
      private var var_933:ActionDefinition;
      
      private var var_508:String;
      
      private var var_1452:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_392 = param1;
         this.var_373 = new FigureData();
         this.var_433 = new PartSetsData();
         this.var_280 = new AnimationData();
         this.var_777 = new AnimationManager();
         this.var_508 = param2;
      ...
      {
         this.var_1452.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_508);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_508);
            return;
         }
         this.var_945 = new AvatarActionManager(param1,this.var_508,param2);
         this.var_933 = this.var_945.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_508);
            return false;
         }
         if(this.var_433.parse(param1))
         {
            if(this.var_508 == AvatarType.const_118)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_508);
            return false;
         }
         return this.var_280.parse(param1);
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_508);
            return false;
         }
         return this.var_373.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_373.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_777.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_373.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_373.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_777.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_777.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_945.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_945.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_945.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_639[param1])
         {
            this.var_639[param1] = new Dictionary();
         }
         if(this.var_639[param1][param2])
         {
            return this.var_639[param1][param2];
         }
         this.var_639[param1][param2] = this.var_373.getMandatorySetTypeIds(param1,param2);
         return this.var_639[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_373.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_945.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_777.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1668[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_280.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_777.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_373.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_373.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1452.getOffset(param1,param2,param3,param4,param5,param6);
      }
