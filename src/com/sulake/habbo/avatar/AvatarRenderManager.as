package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2017:String = "hd-99999-99999";
      ...
      private var var_312:PetDataManager;
      
      private var var_780:PaletteManager;
      
      private var var_609:String;
      
      private var var_313:Map;
      
      private var var_226:AvatarAssetDownloadManager;
      
      private var var_1891:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_609 = RenderMode.const_1571;
         ...
         this.var_103.add(AvatarType.const_118,_loc4_);
         ...
         this.var_103.add(AvatarType.const_65,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_312 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_780 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_312.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_226)
         {
            this.var_226.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_312.init();
         this.var_780.init();
         _loc2_ = this.var_103.getValue(AvatarType.const_118) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_103.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_103.getValue(AvatarType.const_118) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_175.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_226 == null)
               {
                  ...
                  _loc6_ = this.var_175.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_175.getKey("flash.dynamic.avatar.download.url","");
                  this.var_226 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_226.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_875)
         {
            if(this.var_2664 && this.var_2662 && this.var_2663)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_226.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_226.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_103.getValue(AvatarType.const_118) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_226.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1891)
         {
            this.var_1891 = new AvatarFigureContainer(this.const_2017);
         }
         this.var_226.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1891,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_313 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_313.getKeys())
         {
            _loc4_ = this.var_313.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_312.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         ...
         {
            _loc6_ = !this.var_312.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_312.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_103.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_313.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_312.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_103.getValue(AvatarType.const_65);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_313.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_313.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_103.getValue(AvatarType.const_118) as AvatarStructure;
      ...
      {
         return this.var_312 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_65:
               _loc3_ = this.var_103.getValue(AvatarType.const_65) as AvatarStructure;
               break;
            default:
