package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_271:AvatarImageCache;
      
      private var var_572:int = 0;
      
      private var var_1628:int = 0;
      
      private var var_548:AvatarFigureContainer;
      
      private var var_573:Boolean;
      
      private var var_195:Array;
      
      private var var_531:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_548 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_548.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1428 = this.var_1056;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1428);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_275.definition.geometryType);
         if(this.var_45 == null || _loc4_ != null && (this.var_45.width != _loc4_.width || this.var_45.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_275.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_572);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_548,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1428 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_572);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_572);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_548,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_90)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_572);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_469 = this.var_469 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_347:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1522:
                  case AvatarAction.const_1391:
                  case AvatarAction.const_1579:
                  case AvatarAction.const_1083:
                  case AvatarAction.const_1125:
                  case AvatarAction.const_1549:
                  case AvatarAction.const_1437:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_321.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_933);
         this.getCache().resetBodyPartCache(this.var_933);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1427 = this._structure.sortActions(this.var_321);
         ...
         {
            this.var_741 = this._structure.getCanvasOffsets(this.var_1427,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1427)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_400)
               {
                  this.var_858 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_227)
               {
                  this.var_858 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1056 = _loc4_.id;
                     this.var_1609 = _loc4_.breed;
                     break;
                  }
               }
            }
