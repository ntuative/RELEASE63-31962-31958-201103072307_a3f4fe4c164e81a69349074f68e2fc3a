package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_839:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_585.width,this.var_585.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_585,this.var_585.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_866.width,this.var_866.height,true,0);
            _loc5_ = this.var_866.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_839.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_838.width,this.var_838.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_838,this.var_838.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_839)
            {
               switch(this.var_839.clubLevel)
               {
                  case HabboClubLevelEnum.const_55:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_41:
                     _loc4_.style = HabboIconType.const_756;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_44:
                     _loc4_.style = HabboIconType.const_900;
                     _loc4_.visible = true;
               }
            }
            else
