   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_180,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_232,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_269,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_219,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_248,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_67 && var_137 == "")
         {
            var_67.switchCategory(FigureData.const_180);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_hair":
                  this.switchCategory(FigureData.const_180);
                  break;
               case "tab_hat":
