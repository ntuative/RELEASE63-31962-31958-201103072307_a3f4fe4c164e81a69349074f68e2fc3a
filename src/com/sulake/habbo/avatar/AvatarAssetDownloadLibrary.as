package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1510:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1257 = param3 + this.var_813 + ".swf";
         this.var_1257 = this.var_1257.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1510;
         var _loc1_:URLRequest = new URLRequest(this.var_1257);
