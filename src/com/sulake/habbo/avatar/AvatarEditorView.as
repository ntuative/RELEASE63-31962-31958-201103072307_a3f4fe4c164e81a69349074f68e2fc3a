package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1234:IWindowContainer;
      
      public static var var_1496:IWindowContainer;
      
      public static var var_1972:int = 6710886;
      ...
      private var var_523:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_524:IFrameWindow;
      
      private var var_442:Timer;
      
      private var var_2290:Number = 0;
      
      private var var_2737:Boolean = true;
      
      private var var_1940:String;
      
      private var var_2738:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1226 = [];
         this.var_1299 = [AvatarEditorFigureCategory.const_691,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_258,AvatarEditorFigureCategory.const_738,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1234 == null)
         {
            ...
            var_1234 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1496 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1496 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_442 = new Timer(1000);
         this.var_442.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1299;
         }
         for each(_loc6_ in param4)
         {
            this.var_1226.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_442.stop();
            this.var_442.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_442 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1299);
         }
         if(param1.length != this.var_1226.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2737 = this.canChangeOutfit();
            this.var_442.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_523 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_523.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_523.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1226.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_523.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_523.numSelectables)
               {
                  this.var_523.getSelectableAt(_loc6_).x = this.var_523.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1299;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_41) && (this.var_1940 == AvatarEditorSideCategory.const_105 || this.var_2738))
         {
      ...
      {
         if(this.var_1940 == AvatarEditorSideCategory.const_105)
         {
            this.var_2738 = false;
            this.setSideContent(AvatarEditorSideCategory.const_857);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_857:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_351 = param1;
         this.var_523.setSelected(this.var_523.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_524)
         {
            ...
            this.var_524 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_524.procedure = this.stripClubDialogEventProc;
            this.var_524.center();
         }
         else
         {
