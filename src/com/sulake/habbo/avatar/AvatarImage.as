package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1270:String = AvatarSetType.const_35;
      ...
      protected var var_1994:int;
      
      protected var var_275:IActiveActionData;
      ...
      protected var var_271:AvatarImageCache;
      
      protected var var_548:AvatarFigureContainer;
      
      protected var var_531:IAvatarDataContainer;
      
      protected var var_321:Array;
      
      protected var var_45:BitmapData;
      
      private var var_933:IActiveActionData;
      ...
      protected var var_1238:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_548 = param3;
         this.var_271 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1270,const_1269);
         this.var_321 = new Array();
         this.var_933 = new ActiveActionData(AvatarAction.const_356);
         this.var_933.definition = this._structure.getActionDefinition(const_1268);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_758)
         {
            ...
            if(this.var_701)
            {
               for each(_loc2_ in this.var_701)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_548,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1628;
         if(param2 < AvatarDirectionAngle.const_1081)
         {
            param2 = AvatarDirectionAngle.const_316 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_316)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_572,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_241.length == 1 && this.var_89 == this.var_1994)
         {
            return this.var_89 + this.var_469 + this.var_572 % 4;
         }
         if(this.var_241.length == 2)
         {
            for each(_loc1_ in this.var_241)
            {
               ...
               {
                  return this.var_89 + this.var_469 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_572 % 11;
                  return this.var_89 + "_" + this.var_1994 + this.var_469 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2214 || param2 != this.var_2215 || param1 != this.var_2213)
         {
            this.var_2214 = param3;
            this.var_2215 = param2;
            this.var_2213 = param1;
            this.var_1629 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_275.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1238 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1238)
            {
               this.var_45.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_275.definition.geometryType,this.var_89);
         this.var_45.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_572);
         ...
         {
            if(this.var_531.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_531.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_275.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_275.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_572);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_321.push(new ActiveActionData(param1,param2,this.var_572));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_275 = this.var_933;
         this.var_275.definition = this.var_933.definition;
         this.resetBodyPartCache(this.var_933);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_469 = "";
         this.var_241 = this._structure.sortActions(this.var_321);
         if(this.var_241 == null)
         {
            this.var_741 = new Array(0,0,0);
            if(this.var_1310 != "")
            {
               _loc1_ = true;
               this.var_1310 = "";
         ...
         {
            this.var_741 = this._structure.getCanvasOffsets(this.var_241,this._scale,this.var_89);
            for each(_loc4_ in this.var_241)
            {
               this.var_469 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_275)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1309 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1309 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1310 != this.var_469)
            {
               _loc1_ = true;
               this.var_1310 = this.var_469;
            }
         }
         this.var_1308 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_241)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_858 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_195 = this.var_195.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1628 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_531 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_286 || _loc1_.actionType == AvatarAction.const_227 || _loc1_.actionType == AvatarAction.const_400)
               {
                  this.var_858 = true;
               }
            }
