package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1722:String = "no_reqs_info";
      ...
      private var var_1910:IContainerButtonWindow;
      
      private var var_1909:IContainerButtonWindow;
      ...
      {
         this.var_1910 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1909 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1909.procedure = this.onDismissAllButtonClick;
         this.var_1910.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_95,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_161)
         {
         ...
         else if(param1.state == FriendRequest.const_348)
         {
         ...
         else if(param1.state == FriendRequest.const_1158)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_348;
         ...
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_47,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_318,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_348 && _loc4_.state != FriendRequest.const_334)
            {
               _loc4_.state = FriendRequest.const_334;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_318,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_348 && _loc4_.state != FriendRequest.const_334)
            {
               ...
               _loc4_.state = FriendRequest.const_348;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_47,_loc4_.requestId));
               }
            }
         }
         this._friendList.send(_loc3_);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1910,_loc1_);
         this.setEnabled(this.var_1909,_loc1_);
      }
