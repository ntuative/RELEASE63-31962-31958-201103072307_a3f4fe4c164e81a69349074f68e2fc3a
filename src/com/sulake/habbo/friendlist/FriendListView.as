package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1683:String = "noconvinfo";
      
      private static const const_1682:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1266:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1266 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_864 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_257 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1266.prepare(this.var_864);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1128,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1010,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_887,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_815,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_887,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_815,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1265 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1265.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1528 == -1 ? 0 : int(this.var_16.height - this.var_1528);
         var _loc4_:int = this.var_1526 == -1 ? 0 : int(this.var_16.width - this.var_1526);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_257.y = Util.getLowestPoint(this.var_16.content);
         this.var_257.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1154,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_887,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1128,false);
         ...
         this.var_1528 = this.var_16.height;
         this.var_1526 = this.var_16.width;
