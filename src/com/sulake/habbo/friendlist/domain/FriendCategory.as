package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_407:int = 100;
      ...
      {
         if(this.var_869 >= this.getPageCount())
         {
            this.var_869 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_211.length / const_407);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_869 * const_407;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_869 + 1) * const_407,this.var_211.length);
      }
