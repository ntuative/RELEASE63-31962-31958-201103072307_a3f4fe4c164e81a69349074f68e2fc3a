package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            if(!param1 || _loc3_.state != FriendRequest.const_161)
            {
               _loc2_.push(_loc3_);
            }
         }
         for each(_loc4_ in _loc2_)
         {
            ...
            if(this.var_401.view != null)
            {
               this.var_401.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         this.refreshShading();
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_1158;
         this.var_401.view.refreshRequestEntry(_loc2_);
      }
      ...
      {
         this._requests.push(param1);
         this.var_401.view.addRequest(param1);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            this.var_401.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_161)
            {
               _loc1_++;
            }
         }
