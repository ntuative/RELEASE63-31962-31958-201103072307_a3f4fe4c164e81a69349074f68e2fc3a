package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1905:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2666:IContainerButtonWindow;
      
      private var var_2665:IContainerButtonWindow;
      
      private var var_2668:IContainerButtonWindow;
      
      private var var_2667:IContainerButtonWindow;
      
      private var var_60:IItemListWindow;
      
      private var var_415:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_415 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2666 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2665 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2668 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2667 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2666,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2665,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2668,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2667,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_415.method_1(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_415.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_415.closePopup();
         }
