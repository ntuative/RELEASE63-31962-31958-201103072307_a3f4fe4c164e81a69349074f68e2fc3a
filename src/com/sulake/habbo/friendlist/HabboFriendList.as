package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1167:IAvatarRenderManager;
      
      private var var_759:ISessionDataManager;
      
      private var var_2564:FriendListLookAndFeel;
      
      private var var_393:FriendListTabs;
      
      private var var_17:FriendListView;
      
      private var var_1829:OpenedToWebPopup;
      
      private var var_2151:int;
      
      var var_97:FriendCategories;
      
      private var var_366:FriendRequests;
      
      private var var_1830:AvatarSearchResults;
      
      private var var_171:IHabboToolbar;
      
      private var var_973:IHabboNotifications;
      
      private var var_624:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2564 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_97 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1830 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1167)
         {
            this.var_1167.release(new IIDAvatarRenderManager());
            this.var_1167 = null;
         }
         if(this.var_973)
         {
            this.var_973.release(new IIDHabboNotifications());
            this.var_973 = null;
         }
         if(this.var_171)
         {
         ...
         if(this.var_759)
         {
            this.var_759.release(new IIDSessionDataManager());
            this.var_759 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1829 = new OpenedToWebPopup(this);
         }
         this.var_1829.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_101);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_366.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_171.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_307,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1167.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_175.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_175.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1167 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_973 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_366 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_97.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_1176,this.getText("friendlist.friends")));
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_367,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_97.addFriend(new Friend(_loc4_));
         }
         this.var_393 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_624)
         {
         ...
         this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_97.findCategory(FriendCategory.const_367);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this.var_17.openFriendList();
            _loc1_ = this.var_393.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_351));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_366.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_366.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_393.findTab(FriendListTab.const_95).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_366.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_393.findTab(FriendListTab.const_95);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1830.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_393.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_759 || !this.var_366)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_759.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_366.vipLimit;
         }
         else if(this.var_759.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_366.clubLimit;
         }
         if(_loc2_ > this.var_366.limit)
         {
            this.var_366.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_168) as IBitmapWrapperWindow;
