package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_267:MessengerView;
      ...
      {
         var _loc2_:Conversation = this.var_635.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_635.setSelected(_loc2_);
            this.var_267.openMessenger();
      ...
      {
         this.var_635.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_635.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_600.playSound(HabboSoundTypesEnum.const_1222);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_175.getKey("url.prefix",_loc2_);
      ...
      {
         this.var_635 = new Conversations(new ConversationsDeps(this));
         this.var_267 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.MESSENGER));
         ...
         this.var_171.events.dispatchEvent(_loc3_);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_267.isMessengerOpen())
            {
               this.var_267.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_754,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1213,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_635.addMessageAndUpdateView(param1);
         if(!this.var_267.isMessengerOpen())
         {
            if(this.var_600 != null)
            {
               this.var_600.playSound(HabboSoundTypesEnum.const_1065);
            }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_635.addMessageAndUpdateView(_loc3_);
      }
