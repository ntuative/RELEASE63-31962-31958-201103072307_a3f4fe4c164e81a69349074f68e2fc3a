package com.sulake.habbo.messenger.domain
{
   ...
   public class ConversationsDeps implements IConversationsDeps
   {
      ...
      {
         return this.var_124.messengerView.getTabCount();
      }
      
      public function getText(param1:String) : String
      {
         return this.var_124.getText(param1);
      }
      
      public function createConversation(param1:int) : Conversation
      {
         return this.var_124.createConversation(param1);
      }
      ...
      {
         this.var_124.messengerView.addMsgToView(param1,param2);
      }
   }
}
