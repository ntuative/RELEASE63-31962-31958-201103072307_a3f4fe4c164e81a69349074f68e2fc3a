package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1389:uint = 16777215;
      
      private var var_1770:int = 255;
      
      private var var_1151:uint = 16777215;
      
      private var var_1767:int = 255;
      
      private var var_1150:int = 0;
      
      private var var_1768:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_983,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_822,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_698,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_794,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_731,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1150)
         {
            ...
            if(_loc2_ - this.var_1150 >= this.var_1768)
            {
               _loc3_ = this.var_1151;
               _loc4_ = this.var_1767;
               this.var_1150 = 0;
            }
            else
            {
               _loc7_ = this.var_1389 >> 16 & 255;
               _loc8_ = this.var_1389 >> 8 & 255;
               _loc9_ = this.var_1389 & 255;
               _loc10_ = this.var_1151 >> 16 & 255;
               _loc11_ = this.var_1151 >> 8 & 255;
               _loc12_ = this.var_1151 & 255;
               _loc13_ = (_loc2_ - this.var_1150) / this.var_1768;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1770 + (this.var_1767 - this.var_1770) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_822,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_818:
               param2.setString(RoomObjectVariableEnum.const_724,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_773:
               param2.setString(RoomObjectVariableEnum.const_868,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_547:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_245)
               {
                  _loc5_ = "null";
               }
               this.var_471.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_721:
               _loc4_ = this.var_471.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_471.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1059,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1096:
               param2.setNumber(RoomObjectVariableEnum.const_698,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1006:
               param2.setNumber(RoomObjectVariableEnum.const_794,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_731,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1121,int(param1.bgOnly));
         this.var_1389 = this._color;
         this.var_1770 = this.var_1769;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_481,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1477,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1509,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1400,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_481,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_190)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_167 || _loc13_ == RoomPlaneData.const_294)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
