package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_651:int = 500;
       
      
      private var var_1368:Vector3d;
      
      private var var_2841:Vector3d;
      ...
      override public function update(param1:int) : void
      {
         ...
         if(this.var_1368 != null)
         {
            ...
            if(_loc2_ > this.var_1126)
            {
               _loc2_ = this.var_1126;
            }
            _loc3_ = Vector3d.product(this.var_1368,_loc2_ / Number(this.var_1126));
