package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1213:Number = 0.0;
      
      private var var_133:Number = 0.0;
      
      private var var_874:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this._width = param1;
         this._height = param2;
         this.var_518 = this._width;
         this.var_520 = -1;
         this.var_519 = this._height;
         this.var_517 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            if(param3 >= 0)
            {
               ...
               if(param1 > this.var_520)
               {
                  this.var_520 = param1;
               }
               if(param2 < this.var_519)
               {
                  this.var_519 = param2;
               }
            ...
            {
               if(param1 == this.var_518 || param1 == this.var_520)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_519;
                  while(_loc6_ < this.var_517)
                  {
               ...
               if(param2 == this.var_519 || param2 == this.var_517)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_518;
                  while(_loc8_ < this.var_520)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_874 = getFloorHeight(this.var_164);
         if(!param1)
         {
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_167,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_294,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1213);
         this.addPlane(RoomPlaneData.const_167,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_167,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_133) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_167,Vector3d.sum(param1,Vector3d.product(param3,-this.var_133 / param3.length)),Vector3d.product(param3,(param3.length + this.var_133) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1213 / param2.length);
               this.addPlane(RoomPlaneData.const_167,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_190,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_190,_loc13_,new Vector3d(0,0,-this.var_133),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_133,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_133,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_190,_loc13_,new Vector3d(0,0,-this.var_133),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_133,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_133,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_190,_loc13_,new Vector3d(0,0,-this.var_133),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_133,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_133,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_190,_loc13_,new Vector3d(0,0,-this.var_133),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_133,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_133,param11);
                  }
               }
            }
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1111;
         }
         var _loc2_:RoomPlaneData = this.var_134[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
