package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_280:AnimatedFurnitureVisualizationData = null;
      
      private var _state:int = -1;
      
      private var var_107:AnimationStateData;
      ...
      {
         super();
         this.var_107 = new AnimationStateData();
      }
      ...
      {
         return this.var_107.animationId;
      }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_280 = param1 as AnimatedFurnitureVisualizationData;
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(this.usesAnimationResetting())
                  {
                     ...
                     if(_loc4_ > this.var_1509)
                     {
                        this.var_1509 = _loc4_;
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_107,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this.var_280.isImmediateChange(this.var_812,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this.var_280.hasAnimation(this.var_812,_loc6_))
                  {
      ...
      {
         return this.var_107.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_107 != null)
         {
            this.var_107.setLayerCount(this.var_570);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_812)
         {
            this.var_812 = param1;
            this.var_570 = this.var_280.getLayerCount(param1);
      ...
      {
         var _loc2_:* = null;
         if(!this.var_107.animationOver)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_107,param1);
            if(this.var_107.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_107.animationId) || AnimationData.isTransitionToAnimation(this.var_107.animationId))
               {
                  this.setAnimation(this.var_107.animationAfterTransitionId);
                  this.var_107.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_280.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         param1.frameCounter = _loc3_;
         var _loc6_:* = null;
         param1.animationOver = true;
         var _loc7_:int = this.var_570 - 1;
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_1020)
                  {
                     _loc10_ = this.var_280.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_280.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_555)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_107.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_107.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
