package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_154:int = 0;
      ...
      {
         return param1 + param2 * const_1256;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_154,const_77,const_69,const_154,const_77,const_69];
                     _loc8_ = [const_77,const_77,const_77,const_69,const_69,const_69];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
