package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1673:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2756:Number = NaN;
      
      protected var var_2755:int = -1;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_570 != spriteCount)
         {
            createSprites(this.var_570);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null && _loc4_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param2 != this.var_1578)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,param2,this.var_2755);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_448 != _loc3_.getUpdateID() || param1 != var_185 || param2 != this.var_2756)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2755 = _loc3_.getNumber(RoomObjectVariableEnum.const_228);
            ...
            this.var_1237 = _loc3_.getString(RoomObjectVariableEnum.const_369);
      ...
      {
         if(this.var_2124 != param2 || this.var_2123 != param1)
         {
            this.var_843 = [];
            this.var_844 = [];
            this.var_682 = [];
            ...
            this.var_2125 = this.getSize(param1);
            this.var_570 = this._data.getLayerCount(param1) + this.getAdditionalSpriteCount();
            this.var_1578 = this.var_570 - this.getAdditionalSpriteCount();
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_460.length)
         {
            return "";
         }
         var _loc3_:String = this.var_843[param2];
         var _loc4_:Boolean = this.var_844[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2125;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1578)
            {
               _loc6_ = FurnitureVisualizationData.const_460[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_843[param2] = _loc3_;
            this.var_844[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_683[param3] != null && !this.var_1579)
         {
      ...
      {
         if(this.var_684[param2] != null)
         {
            return this.var_684[param2];
         }
         if(this._data == null)
         {
      ...
      {
         if(this.var_680[param3] != null)
         {
            return this.var_680[param3];
         }
         if(this._data == null)
         {
            return true;
