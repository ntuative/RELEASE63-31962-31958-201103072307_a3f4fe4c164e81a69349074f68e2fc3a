package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1346:String = "pet_experience_bubble_png";
      
      private static const const_1348:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this.var_280.commonAssets.getAssetByName(const_1346) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_168)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_396);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_237);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_397) > 0;
            this.var_1683 = _loc3_.getNumber(RoomObjectVariableEnum.const_279);
            this.var_1342 = _loc3_.getNumber(RoomObjectVariableEnum.const_765);
            this.var_2224 = _loc3_.getNumber(RoomObjectVariableEnum.const_630);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1851)
            {
               this.var_1851 = _loc6_;
               this.var_2586 = this.var_1851.toString();
            }
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_261)
         {
            ...
            this.setAnimationForIndex(const_1348,_loc3_);
         }
         if(param2 != this.var_1343)
         {
            this.var_1343 = param2;
            _loc3_ = this.var_280.getAnimationForGesture(var_185,param2);
            this.setAnimationForIndex(const_1347,_loc3_);
         }
      }
      ...
      override protected function updateAnimations(param1:Number) : Array
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_116.length)
         {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2586);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_603)
         {
            ...
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_460.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_460[param2];
               if(_loc4_ == 1)
               {
