   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(this.data != null)
         {
            ...
            _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_1060);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         var _loc6_:String = _loc5_.getString(RoomObjectVariableEnum.const_349);
         var _loc7_:* = !Boolean(_loc5_.getNumber(RoomObjectVariableEnum.const_579));
