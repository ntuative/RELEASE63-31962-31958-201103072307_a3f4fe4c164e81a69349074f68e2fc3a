package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1560:int = const_362;
      ...
      public static const const_287:int = const_122;
      ...
      private var var_2539:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2538:Number = -1.0;
      
      private var var_2537:Number = 1.0;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         while(_loc8_ < param1)
         {
            this.var_361.push(null);
            _loc8_++;
         }
         this._repeatMode = param2;
         this.var_1810 = param3;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_712 != null)
         {
            this.var_712.assign(new Vector3d());
         }
         this.var_615 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_361.length)
         {
            _loc2_ = this.var_361[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      public function createColumn(param1:int, param2:int, param3:Array, param4:int = 1) : Boolean
      {
         ...
         var _loc6_:PlaneMaterialCellColumn = this.var_361[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_361[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_712,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_615,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_361.length)
         {
            _loc11_ = this.var_361[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1810 == const_122)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_615);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_615,this.var_30.width,this.var_615);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_361.length == 1)
         {
            _loc4_ = this.var_361[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
