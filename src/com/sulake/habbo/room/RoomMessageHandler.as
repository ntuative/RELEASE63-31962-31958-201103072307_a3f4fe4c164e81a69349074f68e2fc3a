package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_669.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_669.objectData);
            this.var_669.objectData = null;
         }
         else
         {
            this.var_669.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_669.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_669.objectData = _loc6_;
         }
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_987:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1011:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1187,_loc3_.status);
         }
      }
