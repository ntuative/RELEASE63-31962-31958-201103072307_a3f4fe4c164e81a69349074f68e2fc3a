package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1720:int = 0;
      
      private static const const_969:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_419:String = "place_holder";
      
      private static const const_607:String = "wall_place_holder";
      
      private static const const_609:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_419;
      
      private static const const_608:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_968:String = "selection_arrow";
      ...
      private var var_1467:Map = null;
      
      private var var_642:Map = null;
      
      private var var_513:Map = null;
      
      private var var_511:Map = null;
      
      private var var_783:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2686 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_969)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2687 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2685 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2689 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_969;
         this.initFurnitureData();
      }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_299.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_512.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_512.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_437.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_437.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_783.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_438.add(_loc3_,_loc4_);
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_641.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_642.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_642.remove(_loc7_);
               this.var_642.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2688)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_760));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_513 != null)
         {
            this.var_513.remove(param1);
            this.var_513.add(param1,param2);
         }
         if(this.var_511 != null)
         {
            this.var_511.remove(param2);
            this.var_511.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_513 != null)
         {
            _loc2_ = this.var_513.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_511 != null)
         {
            _loc2_ = this.var_511.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_80;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_80;
      ...
      {
         return [const_419,const_607,const_609,const_608,TILE_CURSOR,const_968];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_438.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_641.getValue(param1) as String;
      ...
      {
         return this.var_963.getValue(param1) as String;
      }
      ...
      {
         var _loc2_:String = this.var_641.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_783.getValue(param1) != null)
         {
            return this.var_783.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_177 || param1 == RoomObjectVisualizationEnum.const_65 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_29 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            if(param1.indexOf("poster") == 0)
            {
               param1 = "poster";
            }
            return int(this.var_642.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2689 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_29:
               this.var_438[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_26:
               this.var_641[param1] = _loc4_;
               break;
            default:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1467.getValue(param1) != null)
         {
            this.var_202 = this.var_1467.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_799,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2686.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1508);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_436[_loc5_] != null)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_431,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1467.add(param1,_loc4_);
         this.var_202 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_784.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_784.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_512.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_784.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_512.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_512.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_242 && _loc5_ != RoomObjectLogicEnum.const_177)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_498.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_437.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_437.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_437[_loc2_] != null)
         {
            _loc3_ = this.var_437.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_332 + param1) == RoomObjectCategoryEnum.const_80)
         {
            return true;
         }
         return false;
      ...
      {
         this.var_438.remove(param1);
         this.var_438.add(param1,param2);
      }
   }
}
