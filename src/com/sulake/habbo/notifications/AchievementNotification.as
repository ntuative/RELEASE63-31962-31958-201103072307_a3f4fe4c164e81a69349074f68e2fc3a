package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1703:String = "badge_bg_001_png";
      
      private const const_1986:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_75 = param10;
         this._assets = param8;
         this.var_299 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2594 = this.var_75.getBadgeName(this.var_308);
         this.var_2592 = this.var_75.getBadgeDesc(this.var_308);
         this.var_2593 = this.var_75.getAchievementNameForFacebook(this.var_308,this.var_299.userName,this.var_299.realName,this.var_1424);
         this.var_2591 = this.var_75.getAchievementDescForFacebook(this.var_308,this.var_299.userName,this.var_299.realName,this.var_1424);
         ...
         this.var_75.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1612.toString());
         this.var_75.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1425.toString());
         this.var_75.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1425.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1852;
         var _loc17_:String = this.var_1852 == 0 ? "pixels" : "activitypoints";
         this.var_75.registerParameter(_loc16_,_loc17_,"" + this.var_2480);
         _loc15_.caption = this.var_75.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1703);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1986) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_75.registerParameter(param1,"badge_name",this.var_2594);
         this.var_75.registerParameter(param1,"badge_desc",this.var_2592);
         this.var_75.registerParameter(param1,"badge_name_fb",this.var_2593);
         this.var_75.registerParameter(param1,"badge_desc_fb",this.var_2591);
         this.var_75.registerParameter(param1,"level",this.var_1424.toString());
         this.var_75.registerParameter(param1,"name",this.var_299.userName);
         return this.var_75.registerParameter(param1,"realname",this.var_299.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_299.events.removeEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImageReady);
            this.var_299 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1703);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_308,this._feedTitleFb,this.var_2595,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2590));
