package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_575:int = 4;
      
      private static const name_2:int = 0;
      
      private static const const_565:int = 1;
      
      private static const const_918:int = 2;
      
      private static const const_917:int = 3;
      
      private static const const_412:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1602 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1602 = 15;
         }
         this.var_1603 = this._window.height;
         this.var_692 = 4;
         this.var_693 = 0;
         this._state = name_2;
         this.var_171 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_565:
               ...
               _loc2_ = Number(this.var_1048) / Number(this.var_396["time_fade_in"]);
               if(this.var_1048 > int(this.var_396["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_918:
               ...
               if(this.var_1296 > int(this.var_396["time_display"]) && !this.var_1601)
               {
                  this.startFadeOut();
               }
               break;
            case const_917:
               ...
               _loc3_ = 1 - Number(this.var_1047) / Number(this.var_396["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1047 > int(this.var_396["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1602;
         if(this._window.height < this.var_1603)
         {
            this._window.height = this.var_1603;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_171.orientation == "TOP" ? int(const_412) : 0;
         var _loc4_:int = this.var_171.orientation == "BOTTOM" ? int(_loc2_.height - const_412) : int(_loc2_.height);
         var _loc5_:int = this.var_171.orientation == "LEFT" ? int(const_412) : 0;
         var _loc6_:int = this.var_171.orientation == "RIGHT" ? int(_loc2_.width - const_412) : int(_loc2_.width);
         if(this.var_396["position_horizontal_follow_toolbar"] == "true" && (this.var_171.orientation != "TOP" && this.var_171.orientation != "BOTTOM"))
         {
            if(this.var_171.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_575;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_575;
            }
         }
         else if(this.var_396["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_575;
         }
         else
         ...
         if(this.var_396["position_vertical_follow_toolbar"] == "true" && (this.var_171.orientation != "RIGHT" && this.var_171.orientation != "LEFT"))
         {
            if(this.var_171.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_692;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_692;
            }
         }
         else if(this.var_396["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_692;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_693;
      }
   }
}
