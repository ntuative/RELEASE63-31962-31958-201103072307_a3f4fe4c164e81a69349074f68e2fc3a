package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_335:IRoomObjectController;
      ...
      {
         if(this.var_335 == param1)
         {
            return;
         }
         if(this.var_335 != null)
         {
            this.var_335.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_335 = param1;
            this.var_335.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_335 != null)
            {
               this.var_335.setLocation(param1.loc);
               this.var_335.setDirection(param1.dir);
            }
         }
      }
   }
