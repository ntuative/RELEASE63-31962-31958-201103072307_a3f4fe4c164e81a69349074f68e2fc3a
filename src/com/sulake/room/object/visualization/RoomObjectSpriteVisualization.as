package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_335:IRoomObject;
      
      private var var_735:IGraphicAssetCollection;
      
      protected var var_448:int = -1;
      
      protected var var_168:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_195 != null)
         {
            ...
            {
               _loc1_ = this.var_195[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_735.removeReference();
         }
         this.var_735 = param1;
         if(this.var_735 != null)
         {
            this.var_735.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_195.length > param1)
         {
            _loc2_ = this.var_195[this.var_195.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_195.length)
         {
      ...
      {
         this.var_448 = 4294967295;
         this.var_168 = 4294967295;
         this.var_185 = -1;
      }
