package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_752:Number = 64;
      
      public static const const_1032:Number = 32;
      ...
      private var var_143:Vector3d;
      
      private var var_144:Vector3d;
      
      private var var_1173:Vector3d;
      ...
      private var var_2809:Number = -500.0;
      
      private var var_2810:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1854 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_83.x * this.var_428,this.var_83.y * this.var_426,this.var_83.z * this.var_427);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_262.x,this.var_262.y,this.var_262.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_428 != param1 * this.var_1855)
         {
            this.var_428 = param1 * this.var_1855;
            ++this.var_159;
         }
      }
      ...
      {
         if(this.var_426 != param1 * this.var_1853)
         {
            this.var_426 = param1 * this.var_1853;
            ++this.var_159;
         }
      }
      ...
      {
         if(this.var_427 != param1 * this.var_1854)
         {
            this.var_427 = param1 * this.var_1854;
            ++this.var_159;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_83.x /= this.var_428;
         this.var_83.y /= this.var_426;
         this.var_83.z /= this.var_427;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_262.x;
         var _loc3_:Number = this.var_262.y;
         var _loc4_:Number = this.var_262.z;
         this.var_262.assign(param1);
         if(this.var_262.x != _loc2_ || this.var_262.y != _loc3_ || this.var_262.z != _loc4_)
         {
            ++this.var_159;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_143.assign(_loc24_);
            this.var_144.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_143.assign(_loc19_);
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_503 != null)
         {
            ...
            this.var_503.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_503.add(_loc3_,_loc4_);
            ++this.var_159;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_503 != null)
         {
            ...
            return this.var_503.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1173.assign(_loc22_);
         }
         else
         {
            this.var_1173.assign(_loc17_);
         }
         ++this.var_159;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_143);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_428;
         _loc2_.y *= this.var_426;
         _loc2_.z *= this.var_427;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1173);
         if(_loc3_ < this.var_2809 || _loc3_ > this.var_2810)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_143);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_426;
            _loc2_.z *= this.var_427;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1173);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_143,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_83.x * this.var_428,this.var_83.y * this.var_426,this.var_83.z * this.var_427);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_144;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_428,param2.y * this.var_426,param2.z * this.var_427);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_428,param3.y * this.var_426,param3.z * this.var_427);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_428,param4.y * this.var_426,param4.z * this.var_427);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1032;
         }
         else
         {
            this.scale = const_752;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_752;
      }
