package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1332:int = 128;
      
      private var var_1333:Boolean = false;
      
      private var var_2795:Point;
      ...
      {
         if(param1 != this.var_1675 || param2 != this.var_1674)
         {
      ...
      {
         if(this.var_1332 > 255 || bitmapData == null)
         {
            return false;
         }
