package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1511 || param1.getUpdateID() != this.var_2203)
         {
            this.var_2203 = param1.getUpdateID();
            if(param2.updateId != this.var_1511 || _loc4_.x != this.var_1063.x || _loc4_.y != this.var_1063.y || _loc4_.z != this.var_1063.z)
            {
