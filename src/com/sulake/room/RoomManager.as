package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2845:IRoomContentLoader;
      
      private var var_618:IRoomObjectFactory = null;
      
      private var var_498:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1163:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_431,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_845,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_618 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_618 == null || this.var_498 == null)
         {
            return;
         }
         this._state = const_1637;
         if(this.var_1163 != null)
         {
            _loc1_ = this.var_1163;
            this.var_1163 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_617.indexOf(_loc5_) < 0)
            {
               this.var_52.loadObjectContent(_loc5_,events);
               this.var_617.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1078;
         return true;
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_616.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_616[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_498.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_498.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_618.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_618 != null)
         {
            return this.var_618.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_668)
         {
            return;
         }
         if(this.var_52 == null)
         {
            this._state = const_668;
            return;
         }
         if(this.var_52.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_617.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_617.splice(_loc2_,1);
            }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_52 == null || this.var_498 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_115.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_115.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_115.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_498.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_498.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_618.createRoomObjectLogic(_loc18_);
