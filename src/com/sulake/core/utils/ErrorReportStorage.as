package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1200:Map = new Map();
      
      private static var var_779:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_779.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_779.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_779.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_779.remove(param1);
         var_779.add(param1,param2);
      }
