package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_539:uint = 0;
      
      protected static var var_525:uint = 0;
       
      
      private var _disposed:Boolean = false;
      
      private var var_98:Object;
      ...
      private var var_1506:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_525 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_98 is Class)
         {
            _loc1_ = new this.var_98() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_98() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_98 = null;
               return;
         ...
         if(this.var_98 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_98).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_98 is BitmapData)
         {
            this._bitmap = this.var_98 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_98 = null;
               return;
         ...
         if(this.var_98 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_98)._bitmap;
            this._offset = BitmapDataAsset(this.var_98)._offset;
            this.var_1255 = BitmapDataAsset(this.var_98).var_1255;
            this.var_1256 = BitmapDataAsset(this.var_98).var_1256;
            if(this._bitmap != null)
            {
               this.var_98 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1255 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1256 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
