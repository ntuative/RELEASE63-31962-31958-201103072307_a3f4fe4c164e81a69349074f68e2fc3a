package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1129:String = "AssetLibraryReady";
      
      public static const const_799:String = "AssetLibraryLoaded";
      
      public static const const_1671:String = "AssetLibraryUnloaded";
      
      public static const const_1502:String = "AssetLibraryLoadError";
      
      private static var var_292:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_477:uint = 0;
      
      private static var var_878:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_718 = new XML();
         this.var_411 = 0;
         this.var_409 = new Array();
         if(var_292 == null)
         {
            var_292 = new Dictionary(false);
         ...
         ++var_477;
         this.var_410 = new Dictionary(false);
         this.var_478 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_878.splice(var_878.indexOf(this),1);
            --var_477;
            this.var_478 = null;
            this.var_877 = null;
            this.var_152 = null;
      ...
      {
         if(this._file == param1.url && this.var_875)
         {
            if(!this.var_876 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_718,this.var_595);
            }
            this.var_876 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1129));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_478)
         {
            _loc2_ = this.var_478[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_478[_loc1_];
         }
         ...
         this.var_875 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1671));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_877[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_478[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1044,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1001,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_986,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1126,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_478[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_478[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_27:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_411;
                     this.var_409.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_478[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_409.length ? this.getAssetByName(this.var_409[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_152)
         {
            ...
            {
               return this.var_409.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_152[param1] != null || (this.var_595 != null ? this.var_595[param1] != null : false);
      }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_152)
            {
               if(this.var_152[_loc2_] == param1)
               {
                  this.var_409.splice(this.var_409.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_292.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_292[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_410.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_410[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_292[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_410[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_292)
            {
               _loc3_ = AssetTypeDeclaration(var_292[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_410)
         {
            _loc3_ = AssetTypeDeclaration(this.var_410[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_292)
            {
               _loc4_ = AssetTypeDeclaration(var_292[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_410)
         {
            _loc4_ = AssetTypeDeclaration(this.var_410[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_718 = _loc2_.manifest.copy();
         this.var_595 = _loc2_.resource;
         ...
         this.var_875 = true;
         dispatchEvent(new Event(AssetLibrary.const_799));
         dispatchEvent(new Event(AssetLibrary.const_1129));
         if(this.var_876)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_718.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_595[param1]);
