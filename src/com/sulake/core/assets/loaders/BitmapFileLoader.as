package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_992 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_991 = new LoaderContext();
         this.var_991.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_991);
         }
      }
      ...
      {
         this.var_992 = param1.url;
         var_322 = 0;
         this.var_42.load(param1,this.var_991);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_322 < var_2769)
            {
               ...
               this.var_42.load(new URLRequest(this.var_992 + (this.var_992.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_322),this.var_991);
               return true;
            }
         }
         return false;
