package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_538:uint;
      
      protected var var_450:uint = 10;
      
      protected var var_807:Boolean = true;
      
      protected var var_384:Boolean = true;
      
      protected var var_693:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_84 = param4;
         this.var_808 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_11 = param7.clone();
         this.var_385 = param7.clone();
         this.var_63 = param7.clone();
         this.var_140 = new Rectangle();
         this.var_141 = null;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this._context = null;
            this._state = WindowState.const_573;
            this.var_808 = null;
         }
      }
      ...
      {
         return this.var_385.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_385.height;
      }
      ...
      {
         return this.var_141.width;
      }
      
      public function getMaximizedHeight() : int
      {
         return this.var_141.height;
      }
