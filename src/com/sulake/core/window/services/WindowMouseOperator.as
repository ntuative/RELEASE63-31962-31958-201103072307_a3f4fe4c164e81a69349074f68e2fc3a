package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_139:DisplayObject;
      ...
      protected var var_657:Point;
      
      protected var var_1323:uint;
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         {
            this.var_139.addEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
            this.var_139.addEventListener(MouseEvent.MOUSE_UP,this.handler,false);
            this.var_139.addEventListener(Event.ENTER_FRAME,this.handler);
            this._mouse.x = this.var_139.mouseX;
            this._mouse.y = this.var_139.mouseY;
            this._window = WindowController(param1);
            this.getMousePositionRelativeTo(param1,this._mouse,this._offset);
            this._window.addEventListener(WindowEvent.const_308,this.clientWindowDestroyed);
            this._working = true;
         }
         return _loc3_;
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            ...
            {
               this.var_139.removeEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
               this.var_139.removeEventListener(MouseEvent.MOUSE_UP,this.handler,false);
               this.var_139.removeEventListener(Event.ENTER_FRAME,this.handler);
               if(!this._window.disposed)
               {
                  this._window.removeEventListener(WindowEvent.const_308,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
      ...
      protected function handler(param1:Event) : void
      {
         ...
         if(this._working)
         {
            if(param1.type == Event.ENTER_FRAME)
            {
               ...
               else if(this._mouse.x != this.var_139.mouseX || this._mouse.y != this.var_139.mouseY)
               {
                  this.operate(this.var_139.mouseX,this.var_139.mouseY);
                  this._mouse.x = this.var_139.mouseX;
                  this._mouse.y = this.var_139.mouseY;
               }
               return;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_657);
         this._window.offset(this.var_657.x - this._offset.x,this.var_657.y - this._offset.y);
      }
