package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1472:uint = 0;
      
      public static const const_896:uint = 1;
      
      public static const const_1164:uint = 2;
      
      public static const const_688:uint = 4;
      
      public static const const_1594:uint = 8;
      
      public static const const_1394:uint = 16;
      
      public static const const_1845:uint = 64;
      
      public static const const_1938:uint = 128;
      
      public static const const_1122:uint = 256;
      
      protected static var var_540:uint = 0;
      
      protected static var var_325:uint = 0;
       
      
      protected var var_204:DisplayObjectContainer;
      
      protected var var_1996:Boolean;
      
      protected var var_802:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1164:
               ...
               break;
            case GraphicContext.const_1594:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1394:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_688:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1122:
               break;
            case GraphicContext.const_1472:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_204.numChildren > 0)
               {
                  this.var_204.removeChildAt(0);
               }
            }
            this.var_204 = null;
            while(numChildren > 0)
         ...
         if(this.var_802)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_325 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1996,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1996,16777215);
                  }
                  var_325 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_802)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_325 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_204 == null)
         {
            ...
            this.var_204.name = this.name + " - Child Container";
            this.var_204.mouseEnabled = false;
      ...
      {
         return this.var_204 != null ? int(this.var_204.numChildren) : 0;
      }
