package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private static var var_35:Rectangle = new Rectangle();
      
      private static const TOP_LEFT:Point = new Point();
       
      
      protected var var_810:Dictionary;
      
      protected var var_811:Dictionary;
      
      private var var_980:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_810 = new Dictionary(false);
         this.var_811 = new Dictionary(false);
         this.var_980 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_980 = null;
            for(_loc1_ in this.var_810)
            {
               _loc2_ = this.var_810[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_810[_loc1_];
            }
            this.var_810 = null;
            for(_loc1_ in this.var_811)
            {
               _loc2_ = this.var_811[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_811[_loc1_];
            }
            this.var_811 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_449[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  _loc12_ = false;
                  _loc13_ = false;
                  var_35.x = _loc10_.region.x + param3.x;
                  var_35.y = _loc10_.region.y + param3.y;
                  var_35.width = _loc10_.region.width;
                  var_35.height = _loc10_.region.height;
                  if(_loc10_.scaleH == SkinLayoutEntity.const_274)
                  {
                     var_35.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_497)
                  {
                     _loc12_ = true;
                     var_35.right += _loc14_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_304)
                  {
                     _loc12_ = true;
                     var_35.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_274)
                  {
                     var_35.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_497)
                  {
                     _loc13_ = true;
                     var_35.bottom += _loc15_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_304)
                  {
                     _loc13_ = true;
                     var_35.bottom += _loc15_;
                     if(true)
                  ...
                  if(!_loc12_ && !_loc13_)
                  {
                     _loc6_.copyPixels(_loc17_,_loc17_.rect,var_35.topLeft,_loc18_,TOP_LEFT,true);
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_304 || _loc10_.scaleH == SkinLayoutEntity.const_304)
                  {
                     ...
                     _loc23_ = 0 % _loc19_;
                     _loc24_ = 0 % _loc20_;
                     _loc25_ = new Point(var_35.x,var_35.y);
                  ...
                  {
                     _loc6_.fillRect(var_35,_loc17_.getPixel(0,0) | _loc18_.getPixel32(0,0) & 4278190080);
                  }
                  else
                  {
                     this.var_980.a = 0 / _loc17_.width;
                     this.var_980.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_35.width,var_35.height,false);
                     _loc30_.draw(_loc17_,this.var_980);
                     _loc31_ = new BitmapData(var_35.width,var_35.height,true,0);
                     _loc31_.draw(_loc18_,this.var_980,null);
                     _loc6_.copyPixels(_loc30_,_loc30_.rect,var_35.topLeft,_loc31_,TOP_LEFT,true);
                     _loc31_.dispose();
                     _loc30_.dispose();
                  }
               }
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_274)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_274)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_810[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_811[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
