package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_909:uint = 8;
      
      private static const const_1238:String = "skin";
      
      private static const const_1241:String = "bitmap";
      
      private static const const_1240:String = "fill";
      
      private static const const_1242:String = "text";
      
      private static const const_1239:String = "label";
      
      private static const const_1237:String = "shape";
      ...
      private var var_388:Dictionary;
      
      private var var_1522:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1522 = new Dictionary();
         this.var_2038 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1522,this.var_2038);
         this.var_2037 = new Dictionary();
         this.var_2039 = new Dictionary();
         StateCodeTable.fillTables(this.var_2037,this.var_2039);
         this.var_388 = new Dictionary();
         this.var_388[const_1238] = BitmapSkinRenderer;
         this.var_388[const_1241] = BitmapDataRenderer;
         this.var_388[const_1240] = FillSkinRenderer;
         this.var_388[const_1242] = TextSkinRenderer;
         this.var_388[const_1239] = LabelRenderer;
         this.var_388[const_1237] = ShapeSkinRenderer;
         this.var_388[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_388[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_323 == null)
         {
            var_323 = new Array();
            var_323.push(WindowState.const_72);
            var_323.push(WindowState.const_82);
            var_323.push(WindowState.const_100);
            var_323.push(WindowState.const_54);
            var_323.push(WindowState.const_98);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2752 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1522[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_816[param1] = new Array(const_909);
         }
         this.var_816[param1][param2] = param3;
         if(this.var_815[param1] == null)
         {
            this.var_815[param1] = new Array(const_909);
         }
         this.var_815[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_181)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_815[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_181)
