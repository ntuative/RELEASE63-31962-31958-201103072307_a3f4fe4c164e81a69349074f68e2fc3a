package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_408:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_408);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowNotifyEvent)
         {
            switch(event.type)
            {
               ...
               case WindowNotifyEvent.const_723:
                  try
                  {
                     getChildByName(const_408).blend = getChildByName(const_408).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1224:
                  type = "null";
                  break;
               case WindowTouchEvent.const_552:
                  type = "null";
            }
