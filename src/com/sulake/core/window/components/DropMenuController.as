package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_270.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_548,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_640 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_371,this,null));
         }
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_180 == null || this.var_180.disposed)
         {
            this.var_180 = context.create(name + "::submenu","",WindowType.const_541,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_270.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_952 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_952)
         {
            if(this.open())
            {
               if(this.var_270.length)
               {
                  this.populateMenuItemContainer(this.var_270,this.getSubMenu(),this.subMenuEventProc);
                  this.var_952 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_952 = false;
            this.getTitleLabel().text = this.var_640 < this.var_270.length && this.var_640 > -1 ? this.var_270[this.var_640] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_479,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_395,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_640 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_640).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_552)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1224:
            case WindowMouseEvent.const_58:
               if(param2 is IDropMenuItemWindow)
               {
                  if(param2.testStateFlag(WindowState.const_98))
                  {
                     this.selection = this.getMenuItemIndex(param2 as IDropMenuItemWindow);
                  }
               }
               break;
            case WindowTouchEvent.const_649:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1168,this,null);
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1053;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1042;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_270[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_270.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_714,this.var_270,PropertyStruct.const_142,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_714)
            {
