package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_425);
         if(_loc1_)
         {
      ...
      {
         if(this.var_425 != param1.name)
         {
            this.var_425 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2335 = _loc2_.textWidth;
         this.var_2336 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_344 != _loc2_.color : this.var_344 != null && this.var_344 != PropertyDefaults.const_702) ? new PropertyStruct(PropertyDefaults.const_399,this.var_344,PropertyStruct.const_132,true) : PropertyDefaults.const_1217);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_750)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_234,this.var_40.left,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_545);
            }
            if(this.var_40.top != PropertyDefaults.const_704)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,this.var_40.top,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_500);
            }
            if(this.var_40.right != PropertyDefaults.const_873)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_215,this.var_40.right,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_496);
            }
            if(this.var_40.bottom != PropertyDefaults.const_777)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,this.var_40.bottom,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_509);
            }
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_355:
