package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_983:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_984:String = "Conversation";
      
      private var var_1225:String = null;
      
      private var var_1939:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1225 == param2)
         {
            return;
         }
         param1.var_1225 = param2;
         param1.var_1939 = null;
         if(param1.var_1225 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1225);
            param1.var_1939 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_898.indexOf(param1) > -1)
         {
            this.var_984 = param1;
         }
      }
      ...
      {
         return this.var_984 == LinkTarget.const_31 ? defaultLinkTarget : this.var_984;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1939;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_637)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_984 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_840,this.var_984,PropertyStruct.const_52,true,PropertyDefaults.const_898));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_840)
            {
               this.var_984 = _loc2_.value as String;
               break;
            }
