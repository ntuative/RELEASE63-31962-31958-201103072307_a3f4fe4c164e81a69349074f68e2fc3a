package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_656:Number;
      
      protected var var_655:Number;
      ...
      protected var var_1999:Boolean = false;
      
      protected var var_533:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_2820:Number = 0.0;
      
      protected var var_2821:Number = 0.0;
      
      protected var var_996:Boolean = true;
      
      protected var var_446:Boolean = false;
      
      protected var var_1242:Boolean = false;
      
      protected var var_1998:int = 0;
      
      protected var var_2000:int = 0;
      
      protected var var_1243:Number;
      
      protected var var_1245:Number;
      
      protected var var_1244:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_106 = 0;
         this.var_94 = 0;
         this._horizontal = param2 == WindowType.const_391;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_167 = var_451 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_395,WindowStyle.const_881,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_50,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_487,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_325,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_514,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1242;
      }
      ...
      {
         var _loc1_:int = this.var_106 - width;
         return _loc1_ < 0 ? 0 : int(_loc1_);
      }
      
      public function get maxScrollV() : int
      {
         var _loc1_:int = this.var_94 - height;
         return _loc1_ < 0 ? 0 : int(_loc1_);
      }
      
      public function get visibleRegion() : Rectangle
      {
         return new Rectangle(this.var_656 * this.maxScrollH,this.var_655 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_656 = param1;
            this._container.x = -this.var_656 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_71);
            dispatchEvent(new WindowEvent(WindowEvent.const_436,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_655)
         {
            this.var_655 = param1;
            this._container.y = -this.var_655 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_71);
            dispatchEvent(new WindowEvent(WindowEvent.const_436,this,null));
         }
      }
      ...
      {
         this.var_2820 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2821 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_534,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_487,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_325,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_514,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(this._horizontal)
         {
            param1.x = this.var_106 + (this.numListItems > 0 ? this._spacing : 0);
            this.var_106 = param1.rectangle.right;
            this._container.width = this.var_106;
         }
         else
         {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_45:
               this.var_1998 = _loc3_;
               this.var_2000 = _loc4_;
               this.var_1243 = 0;
               this.var_1245 = 0;
               this.var_1244 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_192:
               if(this.var_1244)
               {
                  this.var_1243 = this.var_1998 - _loc3_;
                  this.var_1245 = this.var_2000 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1243 != 0 && this.var_106 != 0)
                     {
                        this.scrollH += this.var_1243 / this.var_106;
                     }
                  }
                  else if(this.var_1245 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1245 / this.var_94;
                  }
                  this.var_1998 = _loc3_;
                  this.var_2000 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_197:
               if(this.var_1244)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1243,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1245);
                  }
                  this.var_1244 = false;
                  _loc2_ = true;
               }
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            this.scrollH -= param1 / this.var_106;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_996 && !this.var_533 && this._container)
         {
            this.var_533 = true;
            ...
            if(this._horizontal)
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.x = this.var_106;
                     this.var_106 += _loc2_.width + this._spacing;
                     if(this.var_446)
                     {
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_728)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_406,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1002);
         }
         if(this.var_996 != PropertyDefaults.const_1091)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_753,this.var_996,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1388);
         }
         if(this.var_446 != PropertyDefaults.const_1084)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_791,this.var_446,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1521);
         }
         if(this.var_1242 != PropertyDefaults.const_1117)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_667,this.var_1242,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1427);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_791:
                  ...
                  break;
               case PropertyDefaults.const_667:
                  this.resizeOnItemUpdate = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_753:
