package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1300:String = "increment";
      
      private static const const_1301:String = "decrement";
      
      private static const const_937:String = "slider_track";
      
      private static const const_596:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_654:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_167 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_557;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_50,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_436,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_50,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_436,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_870 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return this.track.findChildByName(const_596) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_596:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_319)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_654;
                  }
                  else
                  {
                     this.scrollV -= this.var_654;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_552)
         {
            ...
            else if(param2.name == const_1301)
            {
               if(this.var_18)
               {
                  this.var_1093 = true;
            ...
            else if(param2.name == const_937)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_596).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_870) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_870) as IScrollableWindow;
               if(_loc1_)
               {
