package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1165:IItemListWindow;
      
      private var var_422:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_82))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_422)
         {
            this.var_422.removeEventListener(WindowEvent.const_303,this.scrollBarEventProc);
            this.var_422.removeEventListener(WindowEvent.const_244,this.scrollBarEventProc);
            this.var_422 = null;
         }
         if(this.var_1165)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1165)
         {
            this.var_1165 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_422)
         {
            this.var_422 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_422)
            {
               this.var_422.addEventListener(WindowEvent.const_303,this.scrollBarEventProc);
               this.var_422.addEventListener(WindowEvent.const_244,this.scrollBarEventProc);
            }
         }
         return this.var_422;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_244)
         {
            this.hideScrollBar();
         }
      }
