package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1243:String = "_SELECTOR";
      
      private static const const_1244:String = "_CONTENT";
       
      
      protected var var_994:ITabSelectorWindow;
      
      protected var var_1990:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_994 = findChildByTag(const_1243) as ITabSelectorWindow;
            if(this.var_994 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1990 = findChildByTag(const_1244) as IWindowContainer;
         }
      ...
      {
         return !!this.var_736 ? this.selector.iterator : null;
      }
