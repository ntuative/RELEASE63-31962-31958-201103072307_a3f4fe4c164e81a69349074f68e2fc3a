package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1230:String = "_TITLE";
      
      private static const const_1311:String = "_HEADER";
      ...
      private var var_1367:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1230) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1367 = findChildByTag(const_1311) as IHeaderWindow;
            if(!this.var_1367)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_177 = findChildByTag(const_1313) as IWindowContainer;
            if(!this.var_177)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1228,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1000 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_292);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_255);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_267);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_267,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_267,false);
            }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_234,_loc3_.left,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,_loc3_.top,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_215,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         }
         else
         {
