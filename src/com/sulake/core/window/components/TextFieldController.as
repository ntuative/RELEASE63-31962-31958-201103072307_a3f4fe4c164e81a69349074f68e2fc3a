package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1503:uint = 500;
      
      protected var var_1253:String = "";
      
      protected var var_1241:Boolean = false;
      
      protected var var_736:Boolean = false;
      ...
      {
         this.var_1253 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1164,var_11);
         }
         return var_22;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_552)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_736 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_335,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_646,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1605);
         _loc1_.push(this.var_1241 != PropertyDefaults.const_1183 ? new PropertyStruct(PropertyDefaults.const_893,this.var_1241,PropertyStruct.const_38,true) : PropertyDefaults.const_1636);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1153 ? new PropertyStruct(PropertyDefaults.const_869,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1438);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1212 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1444);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_869:
                  ...
                  break;
               case PropertyDefaults.const_646:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1145:
