package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1229:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_805:Number;
      
      protected var var_535:Number;
      
      protected var var_536:Boolean;
      
      protected var var_40:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_121:Boolean = false;
      
      protected var var_998:Boolean = false;
      
      private var var_425:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_425,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_425 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_425,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_189);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_847 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_425);
      }
      ...
      {
         this.var_805 = param1;
         this._field.scrollH = this.var_805 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_805 * this.maxScrollH,this.var_535 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_536)
         {
            if(param2.type == WindowNotifyEvent.const_178)
            {
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_425);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1018) ? new PropertyStruct(PropertyDefaults.const_774,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1130) : PropertyDefaults.const_1467);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1190 ? new PropertyStruct(PropertyDefaults.const_825,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1014) : PropertyDefaults.const_1515);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_132,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_238,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1024 ? new PropertyStruct(PropertyDefaults.const_1200,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1221) : PropertyDefaults.const_1384);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_702) ? new PropertyStruct(PropertyDefaults.const_399,this._field.textColor,PropertyStruct.const_132,true) : PropertyDefaults.const_1217);
         _loc1_.push(this.var_425 != TextStyleManager.const_189 ? new PropertyStruct(PropertyDefaults.const_355,this.var_425,PropertyStruct.const_52,true,PropertyDefaults.const_685) : PropertyDefaults.const_988);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_750 ? new PropertyStruct(PropertyDefaults.const_234,this.var_40.left,PropertyStruct.const_40,true) : PropertyDefaults.const_545);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_704 ? new PropertyStruct(PropertyDefaults.const_241,this.var_40.top,PropertyStruct.const_40,true) : PropertyDefaults.const_500);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_873 ? new PropertyStruct(PropertyDefaults.const_215,this.var_40.right,PropertyStruct.const_40,true) : PropertyDefaults.const_496);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_777 ? new PropertyStruct(PropertyDefaults.const_259,this.var_40.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_509);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1218 ? new PropertyStruct(PropertyDefaults.const_631,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1402);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_214,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_214,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_214,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
