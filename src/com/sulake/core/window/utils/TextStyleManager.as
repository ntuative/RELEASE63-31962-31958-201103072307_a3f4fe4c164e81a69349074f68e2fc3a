package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_189:String = "regular";
      ...
      private static var var_522:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_613:String = "{";
      
      private static const const_612:String = "}";
      
      private static const const_1375:String = "/*";
      
      private static const const_1374:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_189],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_189] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_522.indexOf(_loc4_.name) == -1)
            {
               var_522.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_613) != countSubStrings(param1,const_612))
         {
            throw new Error("Mismatching amount of \"" + const_613 + "\" versus \"" + const_612 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1375) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1374) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_613)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
