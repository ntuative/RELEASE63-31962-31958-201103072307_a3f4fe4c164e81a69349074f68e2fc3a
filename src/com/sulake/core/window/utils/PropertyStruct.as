package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2786 = param3 == const_265 || param3 == const_142 || param3 == const_220 || param3 == const_254;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_265:
               ...
               _loc1_ = "<var key=\"" + this.var_571 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_254:
               ...
               break;
            case const_132:
               _loc1_ = "<var key=\"" + this.var_571 + "\" value=\"" + "0x" + uint(this.var_173).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_571 + "\" value=\"" + this.var_173 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
