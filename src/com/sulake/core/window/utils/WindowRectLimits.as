package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_307:int = -2.147483648E9;
      ...
      {
         this.var_307 = param1;
         if(this.var_307 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_307)
         {
      ...
      {
         return this.var_306 == int.MIN_VALUE && this.var_304 == int.MAX_VALUE && this.var_307 == int.MIN_VALUE && this.var_305 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_307)
            {
               this._target.height = this.var_307;
            }
