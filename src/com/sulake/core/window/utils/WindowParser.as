package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1769:String = "_INCLUDE";
      
      public static const const_1792:String = "_TEMP";
      
      private static const const_1288:String = "layout";
      
      private static const const_926:String = "window";
      
      private static const const_928:String = "variables";
      
      private static const const_927:String = "filters";
      
      private static const const_594:String = "name";
      
      private static const const_1273:String = "style";
      
      private static const const_593:String = "params";
      ...
      private static const const_1279:String = "visible";
      
      private static const const_1282:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1012:String = "blend";
      
      private static const const_1286:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1280:String = "treshold";
      
      private static const const_1287:String = "children";
      
      private static const const_1277:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1285:String = "height_min";
      
      private static const const_1284:String = "height_max";
      
      private static const const_592:String = "true";
      
      private static const const_158:String = "0";
      
      private static const const_1283:String = "$";
      ...
      private static const const_1275:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_995:Dictionary;
      
      protected var var_1498:Dictionary;
      
      protected var var_1995:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1240,this.var_1239);
         this.var_995 = new Dictionary();
         this.var_1498 = new Dictionary();
         ParamCodeTable.fillTables(this.var_995,this.var_1498);
         this.var_1995 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1275,const_48);
         return param1.replace(const_1278,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_995)
            {
               delete this.var_995[_loc1_];
            }
            for(_loc1_ in this.var_1498)
            {
               delete this.var_1498[_loc1_];
            }
            this.var_1995.dispose();
            this.var_1995 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1288)
         {
            ...
            _loc9_ = param1.child(const_927).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1240[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_594,variables,"")));
         style = uint(this.parseAttribute(xml,const_1273,variables,style));
         params = uint(this.parseAttribute(xml,const_593,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1274,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_158));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_158));
         rect.width = Number(this.parseAttribute(xml,const_1281,variables,const_158));
         rect.height = Number(this.parseAttribute(xml,const_1276,variables,const_158));
         visible = this.parseAttribute(xml,const_1279,variables,visible.toString()) == const_592;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_593).length() > 0)
         {
            list = xml.child(const_593).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_995[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_594)) + "\"!");
               }
               params |= this.var_995[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_48) : const_48;
         caption = unescape(String(this.parseAttribute(xml,const_1282,variables,caption)));
         if(tag != const_48)
         {
            tags = tag.split(const_1272);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1277,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1285,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1284,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_592;
         blend = Number(this.parseAttribute(xml,const_1012,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1286,variables,window.clipping.toString()) == const_592;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1280,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_927).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_174)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_196)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_48;
         var _loc3_:String = this.var_1239[param1.type];
