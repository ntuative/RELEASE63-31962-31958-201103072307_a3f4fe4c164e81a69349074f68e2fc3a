package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1369:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1370:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_154:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2803 = new Array();
         this.var_154 = this.profiler;
         this._windowManager = param2;
         this.var_879 = param3;
         var _loc4_:ByteArray = new var_1369() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_154)
         {
            this.var_154.removeStopEventListener(this.refresh);
            this.var_154 = null;
         }
         if(!this.var_154 && param1)
         {
            this.var_154 = param1;
            this.var_154.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_755)
            {
               this.var_1726 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_154.getProfilerAgentsInArray();
         ...
         if(this.var_1726)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_154.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_154.numBitmapAssetInstances + " / " + this.var_154.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_879.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_154.numTrackedBitmapDataInstances + " / " + this.var_154.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1370() as ByteArray;
