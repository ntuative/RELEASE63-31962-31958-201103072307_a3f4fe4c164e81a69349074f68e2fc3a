package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1061:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1228:String = "_COLORIZE";
      
      protected static const const_1674:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1303:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_385 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_63 = var_385.clone();
            var_11 = var_385.clone();
         ...
         if(_loc13_)
         {
            var_693 = _loc13_.blend;
            var_450 = _loc13_.var_2752;
      ...
      {
         var_451 = param1;
         var_230 = !!var_451 ? uint(var_230 | var_538) : uint(var_230 & 16777215);
      ...
      {
         var_807 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_439,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_538 = param1 & 4278190080;
         var_230 = !!var_451 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_538 = param1 << 24;
         var_230 = !!var_451 ? uint(var_538 | var_230) : uint(16777215 & var_230);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      
      public function set blend(param1:Number) : void
      {
         var_693 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1012);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_469,this,null));
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_84 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_472,this,null));
         }
      }
      ...
      {
         var_450 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            else
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1017,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_896,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_84,var_19,_context,var_11,null,this.var_653,this.properties,var_808.concat(),_id) as WindowController;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2191 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_492)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_422)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1216,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_622,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_178,this,null));
            }
         }
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_140 != null)
         {
            param3.x = var_140.x;
            param3.y = var_140.y;
            param3.width = var_140.width;
            param3.height = var_140.height;
         }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_140.x = param2.x;
            var_140.y = param2.y;
            var_140.width = param2.width;
            var_140.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_864))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1054;
                  if(testParamFlag(WindowParam.const_393))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_229))
                        {
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_292))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_178:
                  ...
                  if(param1 == this)
                  {
                     this.method_3(new WindowNotifyEvent(WindowNotifyEvent.const_495,this,null));
                     if(testParamFlag(WindowParam.const_174,WindowParam.const_166))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_196,WindowParam.const_159))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_534))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_19 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_280,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_511:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_474);
                  if(param1 == this)
                  {
                     this.method_3(new WindowNotifyEvent(WindowNotifyEvent.const_1043,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_277,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_361:
                  if(param1 == this)
                  {
                     this.method_3(new WindowNotifyEvent(WindowNotifyEvent.const_675,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_469:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1095);
                  break;
               case WindowNotifyEvent.const_472:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1674) == -1)
                     {
                        _loc8_.style = var_84;
                     }
                  }
               ...
               case WindowNotifyEvent.const_439:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_22)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_474);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_886:
                  break;
               case WindowNotifyEvent.const_280:
                  if(testParamFlag(WindowParam.const_66))
                  {
                     expandToAccommodateChild(this,WindowNotifyEvent(param2).related);
                  }
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_178:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1216:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_511:
            ...
            case WindowNotifyEvent.const_995:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1480:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1466:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1050:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_548:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_371:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_746:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_723:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1085:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_863:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1168:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1053:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1174:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1208:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1034:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1116:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_439:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_675:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_239:
               _loc2_ = "null";
         ...
         if(_loc2_ == WindowEvent.const_163)
         {
      ...
      private function method_3(param1:WindowNotifyEvent) : void
      {
         var _loc2_:* = null;
         for each(_loc2_ in this._children)
         {
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_450);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_450);
      }
         ...
         if(this.var_167 && var_450 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1303,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1303,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_139,WindowParam.const_166);
         var _loc2_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_159);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_174)
               {
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_196)
               {
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1114,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1208,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         this.setStateFlag(WindowState.const_72,true);
         _loc1_.type = WindowNotifyEvent.const_1034;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1160;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_361;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1163,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unlock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_72,false);
         _loc1_.type = WindowNotifyEvent.const_1019;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_723;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1085,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1141,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1051;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1060 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1060 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
