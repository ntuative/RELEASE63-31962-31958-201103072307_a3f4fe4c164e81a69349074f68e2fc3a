package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_908:Number = 0.71;
      ...
      private var var_1254:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1182,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1182,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_25.prepareComponent(HabboRoomWidgetLib);
         ...
         this.var_1254 = HabboTracking.getInstance();
         ...
         {
            _loc1_.addEventListener(AssetLoaderEvent.const_27,this.configLoadedHandler);
            _loc1_.addEventListener(AssetLoaderEvent.const_46,this.configLoadedHandler);
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_27,this.configLoadedHandler);
         _loc2_.removeEventListener(AssetLoaderEvent.const_46,this.configLoadedHandler);
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1254 && !this.var_1254.disposed)
                  {
                     this.var_1254.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_908 + this.var_25.getNumberOfFilesLoaded() / _loc11_ * const_908;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
